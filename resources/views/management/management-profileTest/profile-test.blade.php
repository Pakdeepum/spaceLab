                                            ...
                                            <div class="col-lg-6">
                                                <div align="right">
                                                    ...
                                                    <p>
                                                        ...
                                                        $datetoday = date('d-m-Y'); $timetoday = date('H:i:s'); @endphp
                                                        <input type="text" style="width: 70%; margin-bottom:5px;" name="modify"
                                                            value="{{$user['fname']}}" disabled>
                                                        <input type="text" style="width: 34%;" value="{{$datetoday}}" disabled>
                                                        <input type="text" style="width: 34%;" value="{{$timetoday}}" disabled>
                                                ...
                                                <div class="row">
                                                  <div class="col-lg-12">
                                                      ...
                                                      <button ng-show="IsCreateProfile" class="save-button" id="savepro" style="float:right;" ng-click="SaveProfile()" ng-disabled="listitemselectEdit.length<=0||nameCreateProfile.length==0"
                                                          data-url="{{route('profileTest-CreateProfileTest')}}">
                                                          <i class="fa fa-save"></i> Create Profile</button>
                                                      <button ng-show="!IsCreateProfile" ng-click="clickSaveitem()" id="saveItem" data-url="{{route('profileTest-EditProfileTest')}}" ng-disabled="listitemselectEdit.length<=0||nameEditProfile.length==0"
...
<script src="{{asset('js/management/management-profileTest/profileTest.js')}}"></script>
@endsection
