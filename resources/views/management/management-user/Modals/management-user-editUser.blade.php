  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('manageUser.SaveEditUser')}}" method="post" enctype="multipart/form-data">
          {{csrf_field()}}
        <div class="row">
      ...
      <div class="modal-footer">
        <button class="btn save-button"  style="float:left"><i class="fa fa-save"></i> Save</button>
