...
@include('management.management-doctor.Modals.management-doctor-addDoctor')
@include('management.management-doctor.Modals.management-doctor-editDoctor')

<script src="{{asset('js/management/management-doctor/form.js')}}"></script>
