...
@include('management.management-labitem.Modals.management-labitem-add')
@include('management.management-labitem.Modals.management-labitem-edit')
<script src="{{asset('js/management/management-labitem/form.js')}}"></script>
