                                ...
                                <div class="card-body">
                                                ...
                                                <div align="right">
                                                    ...
                                                    <p>
                                                        ...
                                                        <input type="text" style="width: 70%; margin-bottom:5px;" name="modify"
                                                            value="{{$user['fname']}}">
                                                        <input type="text" style="width: 34%;" value="{{$datetoday}}">
                                                        <input type="text" style="width: 34%;" value="{{$timetoday}}">
                                                        <input type="hidden" name="idprofile">
                                                </div>
                                            </div>
                                            <button class="save-button" id="savepro" style="float:right;" ng-click="SaveProfile()"
                                                disabled data-url="{{route('QC-setup-EditProfile')}}">
                                    ...
                                    <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <button ng-click="clickSaveitem()" id="saveItem" data-url="{{route('QC-setup-EditProfileItem')}}"
...
@include('QC.QC-setup.Modals.modals-addprofile')

<script src="{{asset('js/QC/QC-setup/form.js')}}"></script>
@endsection
