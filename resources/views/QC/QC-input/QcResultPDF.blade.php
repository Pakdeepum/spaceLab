    ...
    <header>
        <table style="border:solid 1px #000; line-height: 10px; width: 100%;">
            <tr>
                ...
                @if(isset($detail['profile_name']))
                <td>{{$detail['profile_name']}}</td>
                @endif
                <td><b>QC Name:</b></td>
                @if(isset($detail['qc_name']))
    ...
    <footer>
        ...
        <table style="width: 700px; border-top:groove 1px; border-bottom:solid 1px;">
            <tr>
                ...
                @if(isset($detail[0]->prefix_name_master_report))
                    {{$detail[0]->prefix_name_master_report}}
                @endif
                @if(isset($detail[0]->fname_report))
                {{$detail[0]->fname_report}}
                @endif
                &nbsp;
                @if(isset($detail[0]->lastname_report))
                {{$detail[0]->lastname_report}}
                @endif</td>
                <td><label>Approved By:</label></td>
                <td colspan="3" style="border-right:dotted 1px; text-align:left"></td>-->
                @if (isset($detail[0]->prefix_name_master_approve))
                    {{$detail[0]->prefix_name_master_approve}}
                    @endif @if(isset($detail[0]->fname_approve))
                    {{$detail[0]->fname_approve}}&nbsp;
                    @endif @if(isset($detail[0]->lastname_approve))
                    {{$detail[0]->lastname_approve}}
                    @endif
