...
<link rel="stylesheet" type="text/css" id="theme" href='{{asset("css/custom/checkinput.css")}}'/>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="col-lg-2">
                        <!--<div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="text-center" >
                                    <img class="userimg"  src="{{asset('img/Lis_icon/2018-08-20_12-42-15.png')}}">
                                </p>
                                <hr>
                                <p>ประเภท : OPD</p>
                                <p>Lab No. : 1292058</p>
                    ...
                    <div ng-controller="ReportViewController">
                        ...
                        @include('report.Modals.modals-report-1')
                        @include('report.Modals.modals-report-2')
                        @include('report.Modals.modals-report-3')
                        @include('report.Modals.modals-report-4')
                        @include('report.Modals.modals-report-5')
                        @include('report.Modals.modals-report-6')
                        @include('report.Modals.modals-report-7')
                        @include('report.Modals.modals-report-8')
                        @include('report.Modals.modals-report-9')
                        @include('report.Modals.modals-report-10')
                        @include('report.Modals.modals-report-11')
                        @include('report.Modals.modals-report-12')
                        @include('report.Modals.modals-report-13')
                        @include('report.Modals.modals-report-14')
                        @include('report.Modals.modals-report-15')
                        @include('report.Modals.modals-report-16')
                        @include('report.Modals.modals-report-17')
                        @include('report.Modals.modals-report-18')
                        @include('report.Modals.modals-report-19')
                        @include('report.Modals.modals-report-20')
                        @include('report.Modals.modals-report-21')
                        </div>
                    </div>
                </div>
            </div>
