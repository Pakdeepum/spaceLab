                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-2 text-left" ng-controller="insertPicture" >
                                        ...
                                        <button type="button" class="scan-button" id="browse_file" name="upload" ng-click="InsertPic()">
                                            <img style="padding: 10px;" src='{{asset("img/Lis_icon/scan_icon.png")}}'>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-8 text-left">
                                        <div>
                                            <input type="range" name="range" id="range" min="0" max="350px" step="1" value="100"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" ng-controller="insertPicture">
                                ...
                                <div style="margin-top: 10px;" class="col-lg-3 text-right">
                                    ...
                                    <!-- <a href="{{ url('/main/printImage2') }}" class="btnprn btn">Print Preview</a> -->
                ...
                <div class="col-lg-7">
                    <div class="card">
                        <div class="card-body text-center" style="background-color: #f1f5f9; width: 100%; min-height: 600px;">
                            <img style="max-height: 350px;" src="{{asset('img/Group_270.png')}}" id="img" name="img"  class="text-center"/>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="{{asset('js/main/result-copy-scan/form.js')}}"></script>
