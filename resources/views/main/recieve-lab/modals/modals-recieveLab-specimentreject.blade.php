    ...
    <div style="width: 50%; height:70%;" class="modal-dialog" role="document">
        <div class="modal-content" >
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Reject Specimen</h5>
            </div>
            ...
            <div class="modal-footer">
                <button id="addappointment" data-url="{{route('recieveLab.SaveRejectSpeciment')}}" ng-click="saveSpeciment()"  style="float: left;" class="save-button"disabled>
