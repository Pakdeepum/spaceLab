      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Lab Order</h5>
                    ...
                    <div class="col-lg-12">
                        ...
                        <label>Lab Group Item : </label>
                            <select id="labgroupitem" name="labgroupitem" style="width: 70%" ng-options="lab.lab_sub_group_name for lab in LabSubGroup" ng-model="lab" ng-change="SelectLabSubGroupItem(lab.id_lab_sub_group_item)">
                                ...
                                {{-- <option ng-repeat="data in LabSubGroup" ng-value="data.lab_sub_group_name" ng-model="data" >@{{data.lab_sub_group_name}}</option> --}}
                            </select>
                        </div>
                        <div class="row">
                        <div class="col-lg-6 text-right">
                          <label>Profile Test : </label>
                              <select id="profileTest" name="profileTest" style="width: 50%" ng-options="pro.profile_name for pro in profileTestByGroup" ng-model="pro" ng-change="SelectProfileTest(pro)">
                                  ...
                                  {{-- <option ng-repeat="data in profileTestByGroup">@{{data.profile_name}}</option> --}}
                              </select>
            ...
            <div class="modal-footer">
                <button data-url="{{route('main.AddLabOrder')}}" data-url2="{{route('main.AddLabOrderDetail')}}" id="AddLabOrder"
...
@include('modals-center.modals-patient')
@include('modals-center.modals-department')
@include('modals-center.modals-hospital')
@include('modals-center.modals-clinic')
@include('modals-center.modals-doctor')
@include('modals-center.modals-servicePlan')
@include('modals-center.modals-ward')
