<!-- MODAL REGISTER -->
<div class="modal fade" id="modal-recieveLab-edit" tabindex="-1" style="z-index:2" role="dialog" style="overflow-y: hidden;"
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Edit Lab Order</h5>
            ...
            <div class="modal-footer" ng-controller="EditLabOrderController">
                <button data-url="{{route('main.UpdateLabOrder')}}" data-url2="{{route('main.EditLabOrderDetail')}}" id="EditLabOrder"
                    data-dismiss="modal" style="float: left;" type="button" class="edit-button">
                    <i class="fa fa-save"></i> Edit @{{scope.invalid_ward}}
                </button>
