...
<div class="container-fluid" ng-controller="RecieveLabDataViewController">
    <div class="row">
        ...
        <div class="col-lg-10">
                            ...
                            <div class="col-lg-12 inputgroup">
                              ...
                              <div class="col-lg-8">
                                ...
                                <div style="display:inline-block">
                                    <form method="POST" action="{{route('recieveLab.BarcodeGen')}}" id="labSubmit"
                                        target="_blank">
                                        {{csrf_field()}}
                                ...
                                <div class="row">
                                  <div class="col-lg-12">
                                    ...
                                    @endif
                                    <form action="{{ route('recieveLab.import') }}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    ...
                                    <div class="col-lg-6">
                                      ...
                                      <form action="{{ route('recieveLab.export') }}" method="POST" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                ...
                                <table class="table table-hover tablePointer" style="width:100%"><br>
                                    ...
                                    <tbody>
                                        <tr ng-show="!isFiltered" id="Click" dir-paginate="data in AllDataLabOrderMain | filter:Search | filter:SearchPoint | filter:SearchStatus | itemsPerPage:10"
                                            ...
                                            ng-class="{highlight: selectedMain==data.id_lab_order_main}" style="font-size: 16px;">
                                            <td>
                                            ...
                                            <td>
                                                <center><button class="edit-button" data-val="@{{data.id_lab_order_main}}"
                                                        ...
                                                        {{-- ng-disabled="(data.status!=0&&data.status!=1)?  true : false" --}}
                                                    </button></center>
                                            </td>
                                        </tr>
                                        <tr ng-show="isFiltered" id="Click" dir-paginate="data in newPosts | filter:Search | filter:SearchPoint | filter:SearchStatus | itemsPerPage:10 "
                                            pagination-id="value-paginate" current-page="currentPage" ng-click="Barcode(data.id_lab_order_main,data.lab_order_no)"
                                            ng-class="{highlight: selectedMain==data.id_lab_order_main}" style="font-size: 16px!important;">
                                            <td>
                                                <input type="checkbox" name="print-@{{data.id_lab_order_main}}" id="chk-@{{data.id_lab_order_main}}"
                                                    ng-model="data.selected" ng-click="toggleRecieve(data.id_lab_order_main ,data.lab_order_no,$event)"
                                                    >
            ...
            @include('main.recieve-lab.modals.modals-recieveLab-specimentreject')
        </div>
    </div>
</div>
@include('main.recieve-lab.modals.modals-recieveLab-reg')
@include('main.recieve-lab.modals.modals-recieveLab-edit')

@include('main.recieve-lab.modals.modals-recieveLab-appointment')
@include('main.recieve-lab.modals.modals-recieveLab-specimentNote')

@include('modals-center.modals-doctor')
@include('modals-center.modals-askDelete')
@include('modals-center.modals-askSave')
@include('main.recieve-lab.modals.modals-recieveLab-tat')

<script src="{{asset('js/main/recieve-lab/form.js')}}"></script>
