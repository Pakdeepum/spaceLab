...
class MainResultDocumentPhotoController extends Controller
{
    ...
    public function printImage(Request $request){
        $lab = LabDocumentPhotoList::select('width','height','id_number_photo', 'lab_order_no', 'id_hospital', 'filename', 'note', 'id_lab_order_main', 'hn', 'patient_firstname', 'patient_lastname', 'gender', 'age', 'order_date')
