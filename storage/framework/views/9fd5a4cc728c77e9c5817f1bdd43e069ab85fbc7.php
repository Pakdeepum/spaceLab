    ...
    <div class="modal-dialog modal-lg" role="document" style="width:70%">
        <div class="modal-content" style="overflow: scroll;max-height: -webkit-fill-available;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                $time=date('H:i'); ?>
                                <input disabled type="text" style="width:40%;" value="<?php echo e($date); ?>">
                                <input disabled type="text" style="width:19%;" value="<?php echo e($time); ?>">
                                <input type="hidden" name="userid" value="<?php echo e($user['id_user']); ?>">
                                <input type="hidden" name="hospitalid" value="<?php echo e($user['id_hospital']); ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button ng-click="clickSave()" class="btn save-button" id="saveProfile" style="float:left" data-url="<?php echo e(route('QC.AddprofileitemDetail')); ?>">
                    <i class="fa fa-save"></i> Save</button>
                <button class="btn del-button" data-dismiss="modal">
                    <img src='<?php echo e(asset("img/Lis_icon/cancle_icon.png")); ?>' /> Cancel</button>
            </div>
        </div>
