...
<body>
    ...
    <main>
        <!-- <div style="border-bottom: 1px solid black; border-top: 1px solid black;"> -->
            <table style="width:100%;">
                <tbody>
                    <tr>
                        <td style="width:80%"><span style="font-weight:bold; ">Lab No : <?php echo e($dataLab[0]['lab_order_no']); ?></span></td>
						<td style="width:80%"><span style="font-weight:bold;">Name - Lastname : <?php echo e($dataLab[0]['patient_firstname']); ?> <?php echo e($dataLab[0]['patient_lastname']); ?></span></td>
                    </tr>
                    <tr>
                ...
                <tr>
                    <td style="text-align: center;">
                        <?php if ($dataLab['image']== asset('img/Group_270.png')): ?>
                            <?php echo '<img width="500" height="300" src="img/Group_270.png"'?>
                        <?php else: ?>
    ...
    <table style="width:100%;">
            <tbody>
                ...
                <tr>
                  <td><span style="font-weight:bold;"><span style="font-weight:normal;"><b><?php echo "Print Date : ".date("Y/m/d");?></span></span></td>
                </tr>
            </tbody>
        </table>
    </footer>
