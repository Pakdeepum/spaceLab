...
<!-- START STATUS -->
<label class="status"> รายงาน >> รายงาน LIS </label>
<!-- END STATUS -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table" style="width:100%">
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td>สถิติการตรวจนับ Test</td>
                                        <td><button class="main-button" style="float:right;" ng-click="Report1()">ข้อมูลรายงาน</button></td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>สถิติการทำ Repeat</td>
                                        <td><button class="main-button" style="float:right;" ng-click="Report2()">ข้อมูลรายงาน</button></td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>สถิติการตรวจนับผู้ป่วย</td>
                                        <td><button class="main-button" style="float:right;" ng-click="Report3()">ข้อมูลรายงาน</button></td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>รายงานระยะเวลารอคอยของผู้ป่วย/ครั้งที่มารับบริการ</td>
                                        <td><button class="main-button" style="float:right;" ng-click="Report4()">ข้อมูลรายงาน</button></td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td>สถิตินับภาระงานการทำงานของ User</td>
                                        <td><button class="main-button" style="float:right;" ng-click="Report5()">ข้อมูลรายงาน</button></td>
                                    </tr>
                                    <tr>
                                        <td>6</td>
                                        <td>สถิติการตรวจนับ QC Test ตามโรงพยาบาล</td>
                                        <td><button class="main-button" style="float:right;" ng-click="Report6()">ข้อมูลรายงาน</button></td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                                        <td>เวลาเฉลี่ยการตรวจแต่ละ Test ตามโรงพยาบาล</td>
                                        <td><button class="main-button" style="float:right;" ng-click="Report7()">ข้อมูลรายงาน</button></td>
                                    </tr>
                                    <!--
                                        <tr>
                                            <td>1</td>
                                            <td>รายงานสถิติการสั่งการรักษาตามช่วงเวลา</td>
                                            <td><button class="main-button" style="float:right; background:gray;" ng-click="Report1()" disabled>ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                        ...
                                        <tr>
                                            ...
                                            <td><button class="main-button" style="float:right" ng-click="Report8()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>9</td>
                                            <td>สถิติการส่งตรวจแยกตามสิทธิ</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report9()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>10</td>
                                            <td>รายงานปฏิเสธสิ่งส่งตรวจ</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report10()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>11</td>
                                            <td>รายงานตามระยะเวลารอคอย</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report11()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>12</td>
                                            <td>รายงานเวลาตรวจเฉลี่ยแต่ละ Test</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report12()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>13</td>
                                            <td>ข้อมูลการายงานผลตรวจ</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report13()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>14</td>
                                            <td>รายงานสถิติการตรวจนับ Specimen</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report14()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>15</td>
                                            <td>สถิติการส่งตรวจแยก คน/ครั้ง ตามช่วงเวลา</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report15()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>16</td>
                                            <td>รายงานรายชื่อผู้ป่วยส่งสิ่งส่งตรวจด่วน</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report16()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>17</td>
                                            <td>สถิติการส่งตรวจด่วนแยกตามห้องส่งตรวจ</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report17()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>18</td>
                                            <td>สถิติการรับและรายงานสิ่งส่งตรวจเวลาเฉลี่ย</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report18()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>19</td>
                                            <td>รายงานค่า GFR</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report19()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>20</td>
                                            <td>รายงานกลุ่มที่ตรวจเกินกำหนดจาก Visit</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report20()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>21</td>
                                            <td>รายงานระยะเวลารอคอย ราย Test</td>
                                            <td><button class="main-button" style="float:right" ng-click="Report21()">ข้อมูลรายงาน</button></td>
                                        </tr>
                                        <tr>
                                            <td>22</td>
                                            <td>รายงานสรุปผล</td>
