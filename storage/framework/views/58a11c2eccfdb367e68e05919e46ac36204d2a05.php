                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table class="table" style="width:100%; margin-top:15px">
                            ...
                            <tbody>
                                <tr ng-repeat="data in DataLabSubGroupItemEdit">
                                    <td><input type="checkbox" name="{{data.lab_item_name}}" value="{{data.id_lab_item}}" ng-click="checkEdit(data.id_lab_item)" ng-model="AutoCheck[$index]" ng-click="toggleSelection(data.id_lab_item)"></td>
