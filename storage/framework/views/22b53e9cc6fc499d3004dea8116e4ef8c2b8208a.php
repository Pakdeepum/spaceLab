  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content" style="overflow: scroll; max-height: -webkit-fill-available;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">โรงพยาบาล</h5>
      </div>
              ...
              <table class="table" style="width:100%">
                ...
                <tbody>
                  <tr ng-repeat="data in AllDataHospital">
                    ...
                    <td><button class="main-button" ng-click="Choose(data.id_hospital)" data-dismiss="modal" style="float:right">เลือก</button></td>
                  </tr>
                </tbody>
              </table>
            </div>
