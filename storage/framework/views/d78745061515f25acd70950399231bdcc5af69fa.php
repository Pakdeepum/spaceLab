...
<div class="container-fluid" ng-controller="RecordedResultsDataviewController">
    <div class="row">
        <div class="col-lg-12">
                                ...
                                <div class="card">
                                  <div class="row">
                                      <div class="col-lg-12 text-right push-down-10">
                                        <form action="<?php echo e(route('main.exportWithSelectLab')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <?php echo $__env->make('main.recorded-results.Modals.modals-recorded-redRecord', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo $__env->make('main.recorded-results.Modals.modals-recorded-cancel', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <?php echo $__env->make('modals-center.modals-askSaveWithPincode', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        
        <?php echo $__env->make('modals-center.modals-askConfirmWithPincode', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
