...
<!-- START STATUS -->
<label class="status"> หน้าหลัก >> สำเนาผลตรวจ </label>
<!-- END STATUS -->
                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div style="margin-top: 10px;" class="col-lg-12">
                                    ...
                                    <div class="col-lg-2 text-left" >
                                        <div ng-controller="selectLabController">
                                            <button type="button" class="main-button" name="find" ng-click="Search()">ค้นหา</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div style="margin-top: 10px;" class="col-lg-12">
                                    <div class="col-lg-2 text-right">
                                        <label style="margin-top: 10px;">ชื่อ - สกุล: </label>
                                        <p>
