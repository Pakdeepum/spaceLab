...
<div class="container-fluid" ng-controller="QCViewerDataViewController">
    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <div style="width:100%">
                                        ...
                                        <input type="radio" name="QCtype" style="margin-left:20px;" ng-model="searchType.analyzerType" ng-value="1"> Automation
                                        <input type="radio" name="QCtype" style="margin-left:20px;" ng-model="searchType.analyzerType" ng-value="0"> Key In
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                ...
                                <div class="col-lg-3">
                                    <label style="margin-right: 10px;">วันที่ : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon" id="basic-addon1"><i class="fa fa-calendar"></i></span>
                                        <input type="date" class="form-control" ng-model="date_s" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <label style="margin-right: 10px;">ถึงวันที่ : </label>
                                    <div class="input-group">
                                        <span class="input-group-addon" id="basic-addon1"><i class="fa fa-calendar"></i></span>
                                        <input type="date" class="form-control" ng-model="date_e" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <button class="main-button" style="margin-top: 21px;" ng-click="serachResult()">ค้นหา</button>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-3">
                                        <div align="right">
                                            ...
                                            <input type="text" style="margin-bottom:5px;" ng-model="AllMaxValue" ng-value="AllMaxValue | number:3">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 text-center">
                                        <p>
                                            <label style="color: #1CAF9A;">QC Chart</label>
                                            <br>
                                            <label>กราฟแสดงผลเปรียบเทียบผลการตรวจย้อนหลัง</label>
                                        </p>
