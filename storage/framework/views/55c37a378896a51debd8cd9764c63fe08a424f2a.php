...
<!-- START STATUS -->
<label class="status"> จัดการระบบ >> จัดการข้อมูลแพทย์ </label>
<!-- END STATUS -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-4">
                                            ค้นหา : <input name="search" placeholder="ชื่อ-สกุล" type="text" style="margin-bottom:15px; width:80%">
