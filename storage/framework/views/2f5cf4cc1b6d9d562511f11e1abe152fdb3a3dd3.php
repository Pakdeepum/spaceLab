                        ...
                        <div class="card-body">
                            ...
                            <div class="row" ng-controller="insertPicture">
                                ...
                                <div style="margin-top: 10px;" class="col-lg-3 text-right">
                                    ...
                                    <!-- <a href="<?php echo e(url('/main/printImage2')); ?>" class="btnprn btn">Print Preview</a> -->
                ...
                <div class="col-lg-7">
                    <div class="card">
                        <div class="card-body text-center" style="background-color: #f1f5f9; width: 100%; min-height: 600px;">
                            <img style="max-height: 350px;" src="<?php echo e(asset('img/Group_270.png')); ?>" id="img" name="img"  class="text-center"/>
                        </div>
                    </div>
                </div>
            </div>
