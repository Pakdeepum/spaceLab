...
<body>
                ...
                <tbody>
                    <tr>
                        <td style="with:80%"><span style="font-weight:bold;">Lab No : </span><span style="font-weight:normal;"><?php echo e($dataLab[0]['lab_order_no']); ?></span></td>
						            <td><span style="font-weight:bold;">Name - Lastname : </span><span style="font-weight:normal;"><?php echo e($dataLab[0]['prefix_name']); ?> <?php echo e($dataLab[0]['patient_firstname']); ?> <?php echo e($dataLab[0]['patient_lastname']); ?></span></td>
                    </tr>
                    <tr>
                        <td><span style="font-weight:bold;">HN : </span><span style="font-weight:normal;"><?php echo e($dataLab[0]['hn']); ?></span></td>
                        <td><span style="font-weight:bold;">Sex : </span><span style="font-weight:normal;"><?php echo e($dataLab[0]['gender']); ?></span></td>
                        <td><span style="font-weight:bold;">Age : </span><span style="font-weight:normal;"><?php echo e($dataLab[0]['age']); ?></span></td>
    ...
    <table style="width:100%;">
            <tbody>
                <tr>
                  <td style="with:20%"><span style="font-weight:bold; float:right"><span style="font-weight:normal;"><b><?php echo "Print Date : ".date("Y/m/d");?></span></span></td>
                </tr>
            </tbody>
        </table>
    </footer>
