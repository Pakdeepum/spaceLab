...
<body>
    <header>
        <table style="border:solid 1px #000; line-height: 10px; width: 100%;">
            <tr>
                ...
                <?php if(isset($detail['profile_name'])): ?>
                <td><?php echo e($detail['profile_name']); ?></td>
                <?php endif; ?>
                <td><b>QC Name:</b></td>
                <?php if(isset($detail['qc_name'])): ?>
    ...
    <footer>
        <?php if(isset($detail[0]['critical'])): ?>
        <?php if(count($detail[0]['critical']) > 0): ?>

        <div style="padding-bottom:10px">
            <span style="font-weight: bold;font-size: 16px">Critical Recipient </span>: <span style="font-size: 16px">
                <?php echo e($detail[0]->critical[0]['reciver_name']); ?>

            </span>
            <span style="font-weight: bold;font-size: 16px">Critical Reporter </span>: <span style="font-size: 16px">
                <?php echo e($detail[0]->critical[0]['report_name']); ?>

            </span>
            <span style="font-weight: bold;font-size: 16px">Notified Department </span>: 
            <span style="font-size: 16px">
                <?php echo e($detail[0]->critical[0]['department']); ?> 
            </span>
            <span style="font-weight: bold;font-size: 16px;">Cause </span>: 
            <span style="font-size: 16px">
                <?php echo e($detail[0]->critical[0]['cause']); ?> 
            </span>
        </div>
        <?php endif; ?>
        <?php endif; ?>
        <table style="width: 700px; border-top:groove 1px; border-bottom:solid 1px;">
            <tr>
                ...
                <td colspan="3" style="border-right:dotted 1px; text-align:left">
                <?php if(isset($detail[0]->prefix_name_master_report)): ?>
                    <?php echo e($detail[0]->prefix_name_master_report); ?>

                <?php endif; ?>
                <?php if(isset($detail[0]->fname_report)): ?>
                <?php echo e($detail[0]->fname_report); ?>

                <?php endif; ?>
                &nbsp;
                <?php if(isset($detail[0]->lastname_report)): ?>
                <?php echo e($detail[0]->lastname_report); ?>

                <?php endif; ?></td>
                <td><label>Approved By:</label></td>
                <td colspan="3" style="border-right:dotted 1px; text-align:left"></td>-->
                <?php if(isset($detail[0]->prefix_name_master_approve)): ?>
                    <?php echo e($detail[0]->prefix_name_master_approve); ?>

                    <?php endif; ?> <?php if(isset($detail[0]->fname_approve)): ?>
                    <?php echo e($detail[0]->fname_approve); ?>&nbsp;
                    <?php endif; ?> <?php if(isset($detail[0]->lastname_approve)): ?>
                    <?php echo e($detail[0]->lastname_approve); ?>
