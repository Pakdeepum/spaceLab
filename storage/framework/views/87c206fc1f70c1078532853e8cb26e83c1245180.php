  ...
  <div class="modal-dialog modal-dialog-centered" role="document" style="width:50%; height:auto;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">เพิ่มข้อมูลแพทย์</h5>
      </div>
      <div class="modal-body">
        <form action="<?php echo e(route('management.AddDoctor')); ?>" method="post" enctype="multipart/form-data">
