                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-6 text-right">
                                            <button ng-click="AddAllResult()"
                                                disabled id="btn-save" class="add-button ng-scope" style="margin-bottom:15px; margin-top:15px;">
...
<?php echo $__env->make('QC.QC-input.Modals.modals-inputAdd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<script src="<?php echo e(asset('js/QC/QC-input/form.js')); ?>"></script>
