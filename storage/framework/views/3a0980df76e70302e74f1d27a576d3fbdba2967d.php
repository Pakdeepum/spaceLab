                    ...
                    <div class="col-lg-3">
                        <div class="card" style="background-color: white;">
                            ...
                            <div class="text-left" style="margin-left: 35px; margin-top:35px;">
                                <p class="card-text">User Name : <?php echo e($user->fname ?? 'No Info'); ?></p>
                                <p id="pname" class="card-text">User Group : <?php echo e($groupuser[0]["group_user_name"] ?? 'No Info'); ?></p>
                                <p class="card-text">Register Date : <?php echo e($user->regis_date ?? 'No Info'); ?></p>
                                <p class="card-text"></p>
                            </div>
                            </div>
                            </div>
