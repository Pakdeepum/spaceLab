...
?>
    ...
    <ul class="x-navigation x-navigation-horizontal">
        <li class="xn-logo">
            <a class="btn" href="<?php echo e(url('/Welcome')); ?>"><h2 style="color:#4d79ff; text-align:center; margin-top:7px; ">SPACELAB</h3></a>
            <!-- <img class="logomain" src="<?php echo e(URL::asset('/img/welcome/logo-biosytem.png')); ?>">  -->
        </li>
