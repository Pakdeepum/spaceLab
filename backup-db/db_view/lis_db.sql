/*
 ...
 Source Schema         : lis_web_app

 Target Server Type    : MySQL
 Target Server Version : 100134
 File Encoding         : 65001

 Date: 24/10/2018 11:46:51
*/
...
-- ----------------------------
-- Table structure for appointment_order_data
-- ----------------------------
...
CREATE TABLE `appointment_order_data`  (
  ...
  `id_lab_order_main` int(11) NULL DEFAULT NULL,
  `id_doctor` int(255) NULL DEFAULT NULL,
  `date_order` datetime(0) NULL DEFAULT NULL,
  `date_ts` datetime(0) NULL DEFAULT NULL,
  `status` int(11) NULL DEFAULT 0,
  `stdel` int(11) NULL DEFAULT 0,
  `id_user_ts` int(11) NULL DEFAULT NULL,
  `appointment_for` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_appointment`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of appointment_order_data
-- ----------------------------
INSERT INTO `appointment_order_data` VALUES (1, 125, 1, NULL, NULL, 0, 0, NULL, 'ตรวจโรค', 'คิวแรก');
INSERT INTO `appointment_order_data` VALUES (2, 133, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL);
INSERT INTO `appointment_order_data` VALUES (3, 126, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL);
INSERT INTO `appointment_order_data` VALUES (4, 125, 1, NULL, NULL, 0, 0, NULL, 'DD', 'DD');
INSERT INTO `appointment_order_data` VALUES (5, 125, 1, '2018-09-25 00:00:00', NULL, 0, 0, NULL, 'ตรวจโรค', NULL);
INSERT INTO `appointment_order_data` VALUES (6, 25, 1, '2018-09-28 00:00:00', NULL, 0, 0, NULL, 'ทดสอบ', 'มาช้า');

-- ----------------------------
-- Table structure for clinic_master
-- ----------------------------
DROP TABLE IF EXISTS `clinic_master`;
CREATE TABLE `clinic_master`  (
  `id_clinic` int(11) NOT NULL AUTO_INCREMENT,
  `clinic_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `clinic_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `clinic_note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_clinic`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of clinic_master
-- ----------------------------
INSERT INTO `clinic_master` VALUES (1, '0001', 'คลินิคตา', '', 0, 1);
INSERT INTO `clinic_master` VALUES (2, '0002', 'คลินิคติดยา', NULL, 0, 1);
INSERT INTO `clinic_master` VALUES (3, '0003', 'คลินิครักษาเล็บ', NULL, 0, 1);
...
CREATE TABLE `department_master`  (
  ...
  `department_note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `department_master` VALUES (1, 'ทันตะกรรม', NULL, 0, 1);
INSERT INTO `department_master` VALUES (2, 'ฉุกเฉิน', NULL, 0, 1);
INSERT INTO `department_master` VALUES (3, 'OPD', NULL, 0, 1);
INSERT INTO `department_master` VALUES (4, 'จิตเวช', NULL, 0, 1);
...
) ENGINE = MyISAM AUTO_INCREMENT = 8915 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `district` VALUES (2192, '310610', 'หนองตระครอง   ', 255, 20, 3);
...
INSERT INTO `district` VALUES (2984, '341524', 'ห้วยขะยุง   ', 326, 23, 3);
...
INSERT INTO `district` VALUES (8914, '330320', 'ทุ่งใหญ่', 292, 22, 3);
...
-- ----------------------------
-- Table structure for doctor_master
-- ----------------------------
DROP TABLE IF EXISTS `doctor_master`;
CREATE TABLE `doctor_master`  (
  `id_doctor` int(11) NOT NULL AUTO_INCREMENT,
  `doctor_prefix` int(11) NULL DEFAULT NULL,
  `doctor_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `doctor_lastname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `doctor_department` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `doctor_position` int(11) NULL DEFAULT NULL,
  `doctor_tel` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `doctor_specialty` int(11) NULL DEFAULT NULL,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_doctor`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of doctor_master
-- ----------------------------
INSERT INTO `doctor_master` VALUES (1, 5, 'หมอใหม่', 'หมอดี', '1', 2, '0524441524', 0, 1, 1);

-- ----------------------------
-- Table structure for ethnicity_master
-- ----------------------------
DROP TABLE IF EXISTS `ethnicity_master`;
CREATE TABLE `ethnicity_master`  (
  `id_ethnicity` int(11) NOT NULL AUTO_INCREMENT,
  `ethnicity_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_ethnicity`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 270 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ethnicity_master
-- ----------------------------
INSERT INTO `ethnicity_master` VALUES (1, 'โปรตุเกส', 0);
INSERT INTO `ethnicity_master` VALUES (2, 'ดัตช์', 0);
INSERT INTO `ethnicity_master` VALUES (3, 'เยอรมัน', 0);
INSERT INTO `ethnicity_master` VALUES (4, 'ฝรั่งเศส', 0);
INSERT INTO `ethnicity_master` VALUES (5, 'เดนมาร์ก', 0);
INSERT INTO `ethnicity_master` VALUES (6, 'สวีเดน', 0);
INSERT INTO `ethnicity_master` VALUES (7, 'สวิส', 0);
INSERT INTO `ethnicity_master` VALUES (8, 'อิตาลี', 0);
INSERT INTO `ethnicity_master` VALUES (9, 'นอร์เวย์', 0);
INSERT INTO `ethnicity_master` VALUES (10, 'ออสเตรีย', 0);
INSERT INTO `ethnicity_master` VALUES (11, 'ไอริช', 0);
INSERT INTO `ethnicity_master` VALUES (12, 'ฟินแลนด์', 0);
INSERT INTO `ethnicity_master` VALUES (13, 'เบลเยียม', 0);
INSERT INTO `ethnicity_master` VALUES (14, 'สเปน', 0);
INSERT INTO `ethnicity_master` VALUES (15, 'รัสเซีย', 0);
INSERT INTO `ethnicity_master` VALUES (16, 'โปแลนด์', 0);
INSERT INTO `ethnicity_master` VALUES (17, 'เช็ก', 0);
INSERT INTO `ethnicity_master` VALUES (18, 'ฮังการี', 0);
INSERT INTO `ethnicity_master` VALUES (19, 'กรีก', 0);
INSERT INTO `ethnicity_master` VALUES (20, 'ยูโกสลาฟ', 0);
INSERT INTO `ethnicity_master` VALUES (21, 'ลักเซมเบิร์ก', 0);
INSERT INTO `ethnicity_master` VALUES (22, 'วาติกัน', 0);
INSERT INTO `ethnicity_master` VALUES (23, 'มอลตา', 0);
INSERT INTO `ethnicity_master` VALUES (24, 'ลีซู', 0);
INSERT INTO `ethnicity_master` VALUES (25, 'บัลแกเรีย', 0);
INSERT INTO `ethnicity_master` VALUES (26, 'โรมาเนีย', 0);
INSERT INTO `ethnicity_master` VALUES (27, 'ไซปรัส', 0);
INSERT INTO `ethnicity_master` VALUES (28, 'อเมริกัน', 0);
INSERT INTO `ethnicity_master` VALUES (29, 'แคนาดา', 0);
INSERT INTO `ethnicity_master` VALUES (30, 'เม็กซิโก', 0);
INSERT INTO `ethnicity_master` VALUES (31, 'คิวบา', 0);
INSERT INTO `ethnicity_master` VALUES (32, 'อาร์เจนตินา', 0);
INSERT INTO `ethnicity_master` VALUES (33, 'บราซิล', 0);
INSERT INTO `ethnicity_master` VALUES (34, 'ชิลี', 0);
INSERT INTO `ethnicity_master` VALUES (35, 'อาข่า', 0);
INSERT INTO `ethnicity_master` VALUES (36, 'โคลัมเบีย', 0);
INSERT INTO `ethnicity_master` VALUES (37, 'ลั๊ว', 0);
INSERT INTO `ethnicity_master` VALUES (38, 'เปรู', 0);
INSERT INTO `ethnicity_master` VALUES (39, 'ปานามา', 0);
INSERT INTO `ethnicity_master` VALUES (40, 'อุรุกวัย', 0);
INSERT INTO `ethnicity_master` VALUES (41, 'เวเนซุเอลา', 0);
INSERT INTO `ethnicity_master` VALUES (42, 'เปอร์โตริโก้', 0);
INSERT INTO `ethnicity_master` VALUES (43, 'จีน', 0);
INSERT INTO `ethnicity_master` VALUES (44, 'อินเดีย', 0);
INSERT INTO `ethnicity_master` VALUES (45, 'เวียดนาม', 0);
INSERT INTO `ethnicity_master` VALUES (46, 'ญี่ปุ่น', 0);
INSERT INTO `ethnicity_master` VALUES (47, 'พม่า', 0);
INSERT INTO `ethnicity_master` VALUES (48, 'ฟิลิปปิน', 0);
INSERT INTO `ethnicity_master` VALUES (49, 'มาเลเซีย', 0);
INSERT INTO `ethnicity_master` VALUES (50, 'อินโดนีเซีย', 0);
INSERT INTO `ethnicity_master` VALUES (51, 'ปากีสถาน', 0);
INSERT INTO `ethnicity_master` VALUES (52, 'เกาหลีใต้', 0);
INSERT INTO `ethnicity_master` VALUES (53, 'สิงคโปร์', 0);
INSERT INTO `ethnicity_master` VALUES (54, 'เนปาล', 0);
INSERT INTO `ethnicity_master` VALUES (55, 'ลาว', 0);
INSERT INTO `ethnicity_master` VALUES (56, 'กัมพูชา', 0);
INSERT INTO `ethnicity_master` VALUES (57, 'ศรีลังกา', 0);
INSERT INTO `ethnicity_master` VALUES (58, 'ซาอุดีอาระเบีย', 0);
INSERT INTO `ethnicity_master` VALUES (59, 'อิสราเอล', 0);
INSERT INTO `ethnicity_master` VALUES (60, 'เลบานอน', 0);
INSERT INTO `ethnicity_master` VALUES (61, 'อิหร่าน', 0);
INSERT INTO `ethnicity_master` VALUES (62, 'ตุรกี', 0);
INSERT INTO `ethnicity_master` VALUES (63, 'บังกลาเทศ', 0);
INSERT INTO `ethnicity_master` VALUES (64, 'ถูกถอนสัญชาติ', 0);
INSERT INTO `ethnicity_master` VALUES (65, 'ซีเรีย', 0);
INSERT INTO `ethnicity_master` VALUES (66, 'อิรัก', 0);
INSERT INTO `ethnicity_master` VALUES (67, 'คูเวต', 0);
INSERT INTO `ethnicity_master` VALUES (68, 'บรูไน', 0);
INSERT INTO `ethnicity_master` VALUES (69, 'แอฟริกาใต้', 0);
INSERT INTO `ethnicity_master` VALUES (70, 'กะเหรี่ยง', 0);
INSERT INTO `ethnicity_master` VALUES (71, 'ลาหู่', 0);
INSERT INTO `ethnicity_master` VALUES (72, 'เคนยา', 0);
INSERT INTO `ethnicity_master` VALUES (73, 'อียิปต์', 0);
INSERT INTO `ethnicity_master` VALUES (74, 'เอธิโอเปีย', 0);
INSERT INTO `ethnicity_master` VALUES (75, 'ไนจีเรีย', 0);
INSERT INTO `ethnicity_master` VALUES (76, 'สหรัฐอาหรับเอมิเรตส์', 0);
INSERT INTO `ethnicity_master` VALUES (77, 'กินี', 0);
INSERT INTO `ethnicity_master` VALUES (78, 'ออสเตรเลีย', 0);
INSERT INTO `ethnicity_master` VALUES (79, 'นิวซีแลนด์', 0);
INSERT INTO `ethnicity_master` VALUES (80, 'ปาปัวนิวกินี', 0);
INSERT INTO `ethnicity_master` VALUES (81, 'ม้ง', 0);
INSERT INTO `ethnicity_master` VALUES (82, 'เมี่ยน', 0);
INSERT INTO `ethnicity_master` VALUES (83, 'ชาวเขาที่ไม่ได้รับสัญขาติไทย', 0);
INSERT INTO `ethnicity_master` VALUES (84, '-', 0);
INSERT INTO `ethnicity_master` VALUES (85, 'จีนฮ่อ', 0);
INSERT INTO `ethnicity_master` VALUES (86, 'จีน (อดีตทหารจีนคณะชาติ ,อดีตทหารจีนชาติ)', 0);
INSERT INTO `ethnicity_master` VALUES (87, 'ผู้พลัดถิ่นสัญชาติพม่า', 0);
INSERT INTO `ethnicity_master` VALUES (88, 'ผู้อพยพเชื้อสายจากกัมพูชา', 0);
INSERT INTO `ethnicity_master` VALUES (89, 'ลาว (ลาวอพยพ)', 0);
INSERT INTO `ethnicity_master` VALUES (90, 'เขมรอพยพ', 0);
INSERT INTO `ethnicity_master` VALUES (91, 'ผู้อพยพอินโดจีนสัญชาติเวียดนาม', 0);
INSERT INTO `ethnicity_master` VALUES (92, 'รอให้สัญชาติไทย', 0);
INSERT INTO `ethnicity_master` VALUES (93, 'ไทย-อิสลาม,อิสลาม-ไทย', 0);
INSERT INTO `ethnicity_master` VALUES (94, 'ไทย-จีน,จีน-ไทย', 0);
INSERT INTO `ethnicity_master` VALUES (95, 'ไร้สัญชาติ', 0);
INSERT INTO `ethnicity_master` VALUES (96, 'อื่นๆ', 0);
INSERT INTO `ethnicity_master` VALUES (97, 'ไม่ได้สัญชาติไทย', 0);
INSERT INTO `ethnicity_master` VALUES (98, 'ไทย', 0);
INSERT INTO `ethnicity_master` VALUES (99, 'อัฟกัน', 0);
INSERT INTO `ethnicity_master` VALUES (100, 'บาห์เรน', 0);
INSERT INTO `ethnicity_master` VALUES (101, 'ภูฏาน', 0);
INSERT INTO `ethnicity_master` VALUES (102, 'จอร์แดน', 0);
INSERT INTO `ethnicity_master` VALUES (103, 'เกาหลีเหนือ', 0);
INSERT INTO `ethnicity_master` VALUES (104, 'มัลดีฟ', 0);
INSERT INTO `ethnicity_master` VALUES (105, 'มองโกเลีย', 0);
INSERT INTO `ethnicity_master` VALUES (106, 'โอมาน', 0);
INSERT INTO `ethnicity_master` VALUES (107, 'กาตาร์', 0);
INSERT INTO `ethnicity_master` VALUES (108, 'เยเมน', 0);
INSERT INTO `ethnicity_master` VALUES (109, 'เยเมน(ใต้)**', 0);
INSERT INTO `ethnicity_master` VALUES (110, 'หมู่เกาะฟิจิ', 0);
INSERT INTO `ethnicity_master` VALUES (111, 'คิริบาส', 0);
INSERT INTO `ethnicity_master` VALUES (112, 'นาอูรู', 0);
INSERT INTO `ethnicity_master` VALUES (113, 'หมู่เกาะโซโลมอน', 0);
INSERT INTO `ethnicity_master` VALUES (114, 'ตองก้า', 0);
INSERT INTO `ethnicity_master` VALUES (115, 'ตูวาลู', 0);
INSERT INTO `ethnicity_master` VALUES (116, 'วานูอาตู', 0);
INSERT INTO `ethnicity_master` VALUES (117, 'ซามัว', 0);
INSERT INTO `ethnicity_master` VALUES (118, 'แอลเบเนีย', 0);
INSERT INTO `ethnicity_master` VALUES (119, 'อันดอร์รา', 0);
INSERT INTO `ethnicity_master` VALUES (120, 'เยอรมนีตะวันออก**', 0);
INSERT INTO `ethnicity_master` VALUES (121, 'ไอซ์แลนด์', 0);
INSERT INTO `ethnicity_master` VALUES (122, 'ลิกเตนสไตน์', 0);
INSERT INTO `ethnicity_master` VALUES (123, 'โมนาโก', 0);
INSERT INTO `ethnicity_master` VALUES (124, 'ซานมารีโน', 0);
INSERT INTO `ethnicity_master` VALUES (125, 'บริติช  (อังกฤษ, สก็อตแลนด์)', 0);
INSERT INTO `ethnicity_master` VALUES (126, 'แอลจีเรีย', 0);
INSERT INTO `ethnicity_master` VALUES (127, 'แองโกลา', 0);
INSERT INTO `ethnicity_master` VALUES (128, 'เบนิน', 0);
INSERT INTO `ethnicity_master` VALUES (129, 'บอตสวานา', 0);
INSERT INTO `ethnicity_master` VALUES (130, 'บูร์กินาฟาโซ', 0);
INSERT INTO `ethnicity_master` VALUES (131, 'บุรุนดี', 0);
INSERT INTO `ethnicity_master` VALUES (132, 'แคเมอรูน', 0);
INSERT INTO `ethnicity_master` VALUES (133, 'เคปเวิร์ด', 0);
INSERT INTO `ethnicity_master` VALUES (134, 'แอฟริกากลาง', 0);
INSERT INTO `ethnicity_master` VALUES (135, 'ชาด', 0);
INSERT INTO `ethnicity_master` VALUES (136, 'คอสตาริกา', 0);
INSERT INTO `ethnicity_master` VALUES (137, 'คองโก', 0);
INSERT INTO `ethnicity_master` VALUES (138, 'ไอโวเรี่ยน', 0);
INSERT INTO `ethnicity_master` VALUES (139, 'จิบูตี', 0);
INSERT INTO `ethnicity_master` VALUES (140, 'อิเควทอเรียลกินี', 0);
INSERT INTO `ethnicity_master` VALUES (141, 'กาบอง', 0);
INSERT INTO `ethnicity_master` VALUES (142, 'แกมเบีย', 0);
INSERT INTO `ethnicity_master` VALUES (143, 'กานา', 0);
INSERT INTO `ethnicity_master` VALUES (144, 'กินีบีสเซา', 0);
INSERT INTO `ethnicity_master` VALUES (145, 'เลโซโท', 0);
INSERT INTO `ethnicity_master` VALUES (146, 'ไลบีเรีย', 0);
INSERT INTO `ethnicity_master` VALUES (147, 'ลิเบีย', 0);
INSERT INTO `ethnicity_master` VALUES (148, 'มาลากาซี', 0);
INSERT INTO `ethnicity_master` VALUES (149, 'มาลาวี', 0);
INSERT INTO `ethnicity_master` VALUES (150, 'มาลี', 0);
INSERT INTO `ethnicity_master` VALUES (151, 'มอริเตเนีย', 0);
INSERT INTO `ethnicity_master` VALUES (152, 'มอริเชียส', 0);
INSERT INTO `ethnicity_master` VALUES (153, 'โมร็อกโก', 0);
INSERT INTO `ethnicity_master` VALUES (154, 'โมซัมบิก', 0);
INSERT INTO `ethnicity_master` VALUES (155, 'ไนเจอร์', 0);
INSERT INTO `ethnicity_master` VALUES (156, 'รวันดา', 0);
INSERT INTO `ethnicity_master` VALUES (157, 'เซาโตเมและปรินซิเป', 0);
INSERT INTO `ethnicity_master` VALUES (158, 'เซเนกัล', 0);
INSERT INTO `ethnicity_master` VALUES (159, 'เซเชลส์', 0);
INSERT INTO `ethnicity_master` VALUES (160, 'เซียร์ราลีโอน', 0);
INSERT INTO `ethnicity_master` VALUES (161, 'โซมาลี', 0);
INSERT INTO `ethnicity_master` VALUES (162, 'ซูดาน', 0);
INSERT INTO `ethnicity_master` VALUES (163, 'สวาซี', 0);
INSERT INTO `ethnicity_master` VALUES (164, 'แทนซาเนีย', 0);
INSERT INTO `ethnicity_master` VALUES (165, 'โตโก', 0);
INSERT INTO `ethnicity_master` VALUES (166, 'ตูนิเซีย', 0);
INSERT INTO `ethnicity_master` VALUES (167, 'ยูกันดา', 0);
INSERT INTO `ethnicity_master` VALUES (168, 'ซาอีร์', 0);
INSERT INTO `ethnicity_master` VALUES (169, 'แซมเบีย', 0);
INSERT INTO `ethnicity_master` VALUES (170, 'ซิมบับเว', 0);
INSERT INTO `ethnicity_master` VALUES (171, 'แอนติกาและบาร์บูดา', 0);
INSERT INTO `ethnicity_master` VALUES (172, 'บาฮามาส', 0);
INSERT INTO `ethnicity_master` VALUES (173, 'บาร์เบโดส', 0);
INSERT INTO `ethnicity_master` VALUES (174, 'เบลิซ', 0);
INSERT INTO `ethnicity_master` VALUES (175, 'คอสตาริกา', 0);
INSERT INTO `ethnicity_master` VALUES (176, 'โดมินิกา', 0);
INSERT INTO `ethnicity_master` VALUES (177, 'โดมินิกัน', 0);
INSERT INTO `ethnicity_master` VALUES (178, 'เอลซัลวาดอร์', 0);
INSERT INTO `ethnicity_master` VALUES (179, 'เกรเนดา', 0);
INSERT INTO `ethnicity_master` VALUES (180, 'กัวเตมาลา', 0);
INSERT INTO `ethnicity_master` VALUES (181, 'เฮติ', 0);
INSERT INTO `ethnicity_master` VALUES (182, 'ฮอนดูรัส', 0);
INSERT INTO `ethnicity_master` VALUES (183, 'จาเมกา', 0);
INSERT INTO `ethnicity_master` VALUES (184, 'นิการากัว', 0);
INSERT INTO `ethnicity_master` VALUES (185, 'เซนต์คิตส์และเนวิส', 0);
INSERT INTO `ethnicity_master` VALUES (186, 'เซนต์ลูเซีย', 0);
INSERT INTO `ethnicity_master` VALUES (187, 'เซนต์วินเซนต์และเกรนาดีนส์', 0);
INSERT INTO `ethnicity_master` VALUES (188, 'ตรินิแดดและโตเบโก', 0);
INSERT INTO `ethnicity_master` VALUES (189, 'โบลีเวีย', 0);
INSERT INTO `ethnicity_master` VALUES (190, 'เอกวาดอร์', 0);
INSERT INTO `ethnicity_master` VALUES (191, 'กายอานา', 0);
INSERT INTO `ethnicity_master` VALUES (192, 'ปารากวัย', 0);
INSERT INTO `ethnicity_master` VALUES (193, 'ซูรินาเม', 0);
INSERT INTO `ethnicity_master` VALUES (194, 'อาหรับ', 0);
INSERT INTO `ethnicity_master` VALUES (195, 'คะฉิ่น', 0);
INSERT INTO `ethnicity_master` VALUES (196, 'ว้า', 0);
INSERT INTO `ethnicity_master` VALUES (197, 'ไทยใหญ่', 0);
INSERT INTO `ethnicity_master` VALUES (198, 'ไทยลื้อ', 0);
INSERT INTO `ethnicity_master` VALUES (199, 'ขมุ', 0);
INSERT INTO `ethnicity_master` VALUES (200, 'ตองสู', 0);
INSERT INTO `ethnicity_master` VALUES (201, 'เงี้ยว**', 0);
INSERT INTO `ethnicity_master` VALUES (202, 'ละว้า', 0);
INSERT INTO `ethnicity_master` VALUES (203, 'แม้ว', 0);
INSERT INTO `ethnicity_master` VALUES (204, 'ปะหร่อง', 0);
INSERT INTO `ethnicity_master` VALUES (205, 'ถิ่น', 0);
INSERT INTO `ethnicity_master` VALUES (206, 'ปะโอ', 0);
INSERT INTO `ethnicity_master` VALUES (207, 'มอญ', 0);
INSERT INTO `ethnicity_master` VALUES (208, 'มลาบรี', 0);
INSERT INTO `ethnicity_master` VALUES (209, 'เฮาะ**', 0);
INSERT INTO `ethnicity_master` VALUES (210, 'สก็อตแลน์**', 0);
INSERT INTO `ethnicity_master` VALUES (211, 'จีน (จีนฮ่ออิสระ)', 0);
INSERT INTO `ethnicity_master` VALUES (212, 'จีนอพยพ**', 0);
INSERT INTO `ethnicity_master` VALUES (213, 'จีน (จีนฮ่ออพยพ)', 0);
INSERT INTO `ethnicity_master` VALUES (214, 'ไต้หวัน**', 0);
INSERT INTO `ethnicity_master` VALUES (215, 'ยูเครน', 0);
INSERT INTO `ethnicity_master` VALUES (216, 'อาณานิคมอังกฤษ**', 0);
INSERT INTO `ethnicity_master` VALUES (217, 'ดูไบ**', 0);
INSERT INTO `ethnicity_master` VALUES (218, 'จีน(ฮ่องกง)', 0);
INSERT INTO `ethnicity_master` VALUES (219, 'จีน(ไต้หวัน)', 0);
INSERT INTO `ethnicity_master` VALUES (220, 'โครเอเชีย', 0);
INSERT INTO `ethnicity_master` VALUES (221, 'คาซัค', 0);
INSERT INTO `ethnicity_master` VALUES (222, 'บริทิธ**', 0);
INSERT INTO `ethnicity_master` VALUES (223, 'อาร์เมเนีย', 0);
INSERT INTO `ethnicity_master` VALUES (224, 'อาเซอร์ไบจาน', 0);
INSERT INTO `ethnicity_master` VALUES (225, 'จอร์เจีย', 0);
INSERT INTO `ethnicity_master` VALUES (226, 'คีร์กีซ', 0);
INSERT INTO `ethnicity_master` VALUES (227, 'ทาจิก', 0);
INSERT INTO `ethnicity_master` VALUES (228, 'อุซเบก', 0);
INSERT INTO `ethnicity_master` VALUES (229, 'หมู่เกาะมาร์แชลล์', 0);
INSERT INTO `ethnicity_master` VALUES (230, 'ไมโครนีเซีย', 0);
INSERT INTO `ethnicity_master` VALUES (231, 'ปาเลา', 0);
INSERT INTO `ethnicity_master` VALUES (232, 'เบลารุส', 0);
INSERT INTO `ethnicity_master` VALUES (233, 'บอสเนียและเฮอร์เซโกวีนา', 0);
INSERT INTO `ethnicity_master` VALUES (234, 'เติร์กเมน', 0);
INSERT INTO `ethnicity_master` VALUES (235, 'เอสโตเนีย', 0);
INSERT INTO `ethnicity_master` VALUES (236, 'ลัตเวีย', 0);
INSERT INTO `ethnicity_master` VALUES (237, 'ลิทัวเนีย', 0);
INSERT INTO `ethnicity_master` VALUES (238, 'มาซิโดเนีย', 0);
INSERT INTO `ethnicity_master` VALUES (239, 'มอลโดวา', 0);
INSERT INTO `ethnicity_master` VALUES (240, 'สโลวัก', 0);
INSERT INTO `ethnicity_master` VALUES (241, 'สโลวีน', 0);
INSERT INTO `ethnicity_master` VALUES (242, 'เอริเทรีย', 0);
INSERT INTO `ethnicity_master` VALUES (243, 'นามิเบีย', 0);
INSERT INTO `ethnicity_master` VALUES (244, 'โบลิเวีย', 0);
INSERT INTO `ethnicity_master` VALUES (245, 'หมู่เกาะคุก', 0);
INSERT INTO `ethnicity_master` VALUES (246, 'เนปาล (เนปาลอพยพ)', 0);
INSERT INTO `ethnicity_master` VALUES (247, 'มอญ  (ผู้พลัดถิ่นสัญชาติพม่า)', 0);
INSERT INTO `ethnicity_master` VALUES (248, 'ไทยใหญ่  (ผู้พลัดถิ่นสัญชาติพม่า)', 0);
INSERT INTO `ethnicity_master` VALUES (249, 'เวียดนาม  (ญวนอพยพ)', 0);
INSERT INTO `ethnicity_master` VALUES (250, 'มาเลเชีย  (อดีต จีนคอมมิวนิสต์)', 0);
INSERT INTO `ethnicity_master` VALUES (251, 'จีน  (อดีต จีนคอมมิวนิสต์)', 0);
INSERT INTO `ethnicity_master` VALUES (252, 'สิงคโปร์  (อดีต จีนคอมมิวนิสต์)', 0);
INSERT INTO `ethnicity_master` VALUES (253, 'กะเหรี่ยง  (ผู้หลบหนีเข้าเมือง)', 0);
INSERT INTO `ethnicity_master` VALUES (254, 'มอญ  (ผู้หลบหนีเข้าเมือง)', 0);
INSERT INTO `ethnicity_master` VALUES (255, 'ไทยใหญ่  (ผู้หลบหนีเข้าเมือง)', 0);
INSERT INTO `ethnicity_master` VALUES (256, 'กัมพูชา  (ผู้หลบหนีเข้าเมือง)', 0);
INSERT INTO `ethnicity_master` VALUES (257, 'มอญ  (ชุมชนบนพื้นที่สูง)', 0);
INSERT INTO `ethnicity_master` VALUES (258, 'กะเหรี่ยง  (ชุมชนบนพื้นที่สูง)', 0);
INSERT INTO `ethnicity_master` VALUES (259, 'ปาเลสไตน์', 0);
INSERT INTO `ethnicity_master` VALUES (260, 'ติมอร์ตะวันออก', 0);
INSERT INTO `ethnicity_master` VALUES (261, 'สละสัญชาติไทย', 0);
INSERT INTO `ethnicity_master` VALUES (262, 'เซอร์เบีย แอนด์ มอนเตเนโกร', 0);
INSERT INTO `ethnicity_master` VALUES (263, 'กัมพูชา(แรงงาน)', 0);
INSERT INTO `ethnicity_master` VALUES (264, 'พม่า(แรงงาน)', 0);
INSERT INTO `ethnicity_master` VALUES (265, 'ลาว(แรงงาน)', 0);
INSERT INTO `ethnicity_master` VALUES (266, 'เซอร์เบียน', 0);
INSERT INTO `ethnicity_master` VALUES (267, 'มอนเตเนกริน', 0);
INSERT INTO `ethnicity_master` VALUES (268, 'บุคคลที่ไม่มีสถานะทางทะเบียน', 0);
INSERT INTO `ethnicity_master` VALUES (269, 'ไม่ระบุ', 0);

-- ----------------------------
-- Table structure for form_lab_master
-- ----------------------------
...
CREATE TABLE `form_lab_master`  (
  ...
  `form_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_form`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for group_barcode_master
-- ----------------------------
DROP TABLE IF EXISTS `group_barcode_master`;
CREATE TABLE `group_barcode_master`  (
  `id_group_barcode` int(11) NOT NULL AUTO_INCREMENT,
  `group_barcode_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `id_hospital` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_group_barcode`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of group_barcode_master
-- ----------------------------
INSERT INTO `group_barcode_master` VALUES (1, 'TEST0021', 1, 0);
INSERT INTO `group_barcode_master` VALUES (2, 'TEST0021', 1, 0);
INSERT INTO `group_barcode_master` VALUES (3, 'Cloted Blood', 1, 0);
INSERT INTO `group_barcode_master` VALUES (4, 'Cloted Blood', 1, 1);
INSERT INTO `group_barcode_master` VALUES (5, 'EDTA Blood', 1, 0);
INSERT INTO `group_barcode_master` VALUES (6, 'NAF Blood', 1, 0);

-- ----------------------------
-- Table structure for group_result_master
-- ----------------------------
DROP TABLE IF EXISTS `group_result_master`;
CREATE TABLE `group_result_master`  (
  `id_group_result` int(11) NOT NULL AUTO_INCREMENT,
  `group_result_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `id_hospital` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_group_result`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of group_result_master
-- ----------------------------
INSERT INTO `group_result_master` VALUES (1, 'ทดสอบรายการ', 1, 0);

-- ----------------------------
-- Table structure for group_user_master
-- ----------------------------
DROP TABLE IF EXISTS `group_user_master`;
CREATE TABLE `group_user_master`  (
  `id_group_user` int(11) NOT NULL AUTO_INCREMENT,
  `group_user_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_group_user`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of group_user_master
-- ----------------------------
INSERT INTO `group_user_master` VALUES (1, 'Admin', 0, 0);
INSERT INTO `group_user_master` VALUES (2, 'UserNormal', 0, 1);

-- ----------------------------
-- Table structure for hospital_master
-- ----------------------------
DROP TABLE IF EXISTS `hospital_master`;
CREATE TABLE `hospital_master`  (
  `id_hospital` int(11) NOT NULL AUTO_INCREMENT,
  `hn_hospital` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `hospital_tel` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_hospital`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hospital_master
-- ----------------------------
INSERT INTO `hospital_master` VALUES (1, 'HN000001', 'โรงพยาบาลสวนปรุง', 'เชียงใหม่', '08394514424', 0);
INSERT INTO `hospital_master` VALUES (2, 'HN000002', 'โรงพยาบาลสวนดอก', 'เชียงใหม่', '0215488452', 0);
INSERT INTO `hospital_master` VALUES (3, 'HN000003', 'โรงพยาบาลสัตว์เล็ก', 'เชียงใหม่', '0002154545', 0);
INSERT INTO `hospital_master` VALUES (4, 'HN000010', 'โรงพยาบาลสัตว์ใหญ่', 'เชียงใหม่', '0254156156', 0);

-- ----------------------------
-- Table structure for lab_barcode_master
-- ----------------------------
DROP TABLE IF EXISTS `lab_barcode_master`;
CREATE TABLE `lab_barcode_master`  (
  `id_lab_barcode` int(11) NOT NULL AUTO_INCREMENT,
  `lab_barcode_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `id_hospital` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_lab_barcode`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of lab_barcode_master
-- ----------------------------
INSERT INTO `lab_barcode_master` VALUES (1, 'ทดสอบ Lab barcode', 1, 0);
INSERT INTO `lab_barcode_master` VALUES (2, 'ทดสอบ Lab barcode2', 1, 0);

-- ----------------------------
-- Table structure for lab_item_master
-- ----------------------------
DROP TABLE IF EXISTS `lab_item_master`;
CREATE TABLE `lab_item_master`  (
  `id_lab_item` int(11) NOT NULL AUTO_INCREMENT,
  `lab_item_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lab_item_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lab_item_unit` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lab_default_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '-',
  `id_lab_item_sub_group` int(11) NULL DEFAULT 0,
  `possible_value_flag` int(11) NULL DEFAULT NULL,
  `critical_value_flag` int(11) NULL DEFAULT NULL,
  `tat_default` int(11) NULL DEFAULT 60,
  `note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `mean_normal` float(255, 0) NULL DEFAULT 0,
  `sd_normal` float(255, 0) NULL DEFAULT 0,
  `status` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  `lab_normal_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '-',
  `lab_male_normal_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '-',
  `lab_female_normal_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '-',
  `lab_child_normal_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '-',
  `lab_pad_normal_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_group_barcode` int(11) NULL DEFAULT NULL,
  `id_group_result` int(11) NULL DEFAULT NULL,
  `id_lab_barcode` int(11) NULL DEFAULT NULL,
  `id_Item_type` int(11) NULL DEFAULT NULL,
  `id_lab_specimen_item` int(11) NULL DEFAULT NULL,
  `hint` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `thai_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `eng_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `critical_value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `out_lab` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_lab_item`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 44 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lab_item_master
-- ----------------------------
INSERT INTO `lab_item_master` VALUES (1, 'WBC', '0001', 'mg/dl', '', 0, NULL, NULL, 60, '', 0, 0, 0, 0, 1, '20-30', '25-35', '20-30', '15-25', NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (2, 'WBC correct', '0002', 'mg/dl', '22222', 0, NULL, NULL, 60, '', 0, 0, 0, 0, 1, '20', '', '', '', NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (3, 'Plt count', '0003', 'mg/dl', '', 1, NULL, NULL, 60, '', 0, 0, 0, 0, 1, '20', '', '', '', NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (4, 'Platelet smear', '0004', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (5, 'Creatinine', '0005', 'mg/dl', NULL, 5, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (6, 'WBC Differential', '0006', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (7, 'Neutrophils', '0007', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (8, 'Lymphocyte', '0008', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (9, 'Monocyte', '0009', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (10, 'Eosinophil', '0010', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (11, 'Basophil', '0011', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (12, 'Atyp.lymp', '0012', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (13, 'Band form', '0013', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (14, 'Blast cell', '0014', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (15, 'Promyelocyte', '0015', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (16, 'Myelocyte', '0016', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (17, 'Metamyelocyte', '0017', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (18, 'PT', '0018', 'mg/dl', NULL, 2, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (19, 'INR', '0019', 'mg/dl', NULL, 2, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (20, 'PTT', '0020', 'mg/dl', NULL, 0, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (21, 'Na', '0021', 'mg/dl', NULL, 0, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (22, 'K', '0022', 'mg/dl', NULL, 0, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (23, 'Cl', '0023', 'mg/dl', NULL, 0, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (24, 'CO2', '0024', 'mg/dl', NULL, 2, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (25, 'Gap (Calculated)', '0025', 'mg/dl', NULL, 1, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (26, 'Total Protein', '0026', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (27, 'Albumin', '0027', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (28, 'Globulin', '0028', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (29, 'AST (SGOT)', '0029', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (30, 'ALT (SGPT)', '0030', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (31, 'Alk.Phosphatase(ALP)', '0031', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (32, 'Cholesterol', '0032', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (33, 'Total Bilirubin', '0033', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (34, 'Direct bilirubin', '0034', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (35, 'Indirect bilirubin', '0035', 'mg/dl', NULL, 4, NULL, NULL, 60, NULL, 0, 0, 0, 0, 2, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (40, 'aPTT', 'LB0012', '-', '-', 0, NULL, NULL, 60, 'ทดสอบ', 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (41, 'Renin', '009203', 'ng/mL/hr.', '-', 0, NULL, NULL, 60, '-', 0, 0, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `lab_item_master` VALUES (42, 'TESTLAB', 'TEST0002', 'mm/ont2', '20', 0, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, '20-40', '20-50', '15-40', '10-20', '10-20', 1, 1, 1, 1, 1, 'test', 'ทดสอบแลป', 'TEST', '100', 1);
INSERT INTO `lab_item_master` VALUES (43, 'Hct', '100', '.', '.', 0, NULL, NULL, 60, NULL, 0, 0, 0, 0, 1, '35-50', '40-50', '37-48', '.', '.', 0, 0, 0, 14, 0, 'hct', 'Hct', 'Hct', '.', 0);

-- ----------------------------
-- Table structure for lab_item_type_master
-- ----------------------------
DROP TABLE IF EXISTS `lab_item_type_master`;
CREATE TABLE `lab_item_type_master`  (
  `id_Item_type` int(11) NOT NULL AUTO_INCREMENT,
  `item_type_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `id_hospital` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_Item_type`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of lab_item_type_master
-- ----------------------------
INSERT INTO `lab_item_type_master` VALUES (1, 'LAB001', 1, 0);
INSERT INTO `lab_item_type_master` VALUES (13, 'LAB02', 1, 0);
INSERT INTO `lab_item_type_master` VALUES (14, 'Hematology', 1, 0);

-- ----------------------------
-- Table structure for lab_order_detail
-- ----------------------------
DROP TABLE IF EXISTS `lab_order_detail`;
CREATE TABLE `lab_order_detail`  (
  `id_lab_order_detail` int(11) NOT NULL AUTO_INCREMENT,
  `id_lab_order_main` int(11) NULL DEFAULT NULL,
  `id_lab_item` int(11) NULL DEFAULT NULL,
  `lab_result` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '-',
  `lab_result_repeat` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '-',
  `report_date` datetime(0) NULL DEFAULT NULL,
  `report_id_user` int(11) NULL DEFAULT NULL,
  `approve_date` datetime(0) NULL DEFAULT NULL,
  `approve_id_user` int(11) NULL DEFAULT NULL,
  `price` double(10, 0) NULL DEFAULT NULL,
  `discount` double(10, 0) NULL DEFAULT NULL,
  `total_price` double(10, 0) NULL DEFAULT NULL,
  `id_lab_specimen_item` int(11) NULL DEFAULT NULL,
  `result_flag` int(11) NULL DEFAULT 0 COMMENT '1ต่ำ 2ปกติ 3สูง',
  `critical_flag` int(11) NULL DEFAULT 0,
  `tat` int(11) NULL DEFAULT 60,
  `priority` int(11) NULL DEFAULT 1,
  `stdel` int(11) NULL DEFAULT 0,
  `status` int(11) NULL DEFAULT 1,
  `normal_range` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_lab_order_detail`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 72 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lab_order_detail
-- ----------------------------
INSERT INTO `lab_order_detail` VALUES (50, 23, 18, '2', '-', '2018-10-09 03:07:55', 1, '2018-10-09 03:08:20', 1, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 4, 'null');
INSERT INTO `lab_order_detail` VALUES (51, 23, 19, '28', '-', '2018-10-09 03:07:55', 1, '2018-10-09 03:08:21', 1, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 4, 'null');
INSERT INTO `lab_order_detail` VALUES (52, 23, 20, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 2, NULL);
INSERT INTO `lab_order_detail` VALUES (53, 23, 1, '3', '-', '2018-10-09 03:07:56', 1, '2018-10-09 03:08:22', 1, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 4, 'null');
INSERT INTO `lab_order_detail` VALUES (54, 23, 2, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 2, NULL);
INSERT INTO `lab_order_detail` VALUES (55, 23, 3, '54', '-', '2018-10-09 03:07:57', 1, '2018-10-09 03:08:22', 1, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 4, 'null');
INSERT INTO `lab_order_detail` VALUES (56, 23, 22, '68', '-', '2018-10-09 03:07:57', 1, '2018-10-09 03:08:23', 1, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 4, 'null');
INSERT INTO `lab_order_detail` VALUES (57, 23, 24, '99', '-', '2018-10-09 03:07:58', 1, '2018-10-09 03:08:23', 1, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 4, 'null');
INSERT INTO `lab_order_detail` VALUES (58, 24, 1, '20', '-', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 3, '20-30');
INSERT INTO `lab_order_detail` VALUES (59, 24, 2, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 2, '-');
INSERT INTO `lab_order_detail` VALUES (60, 24, 18, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 2, '-');
INSERT INTO `lab_order_detail` VALUES (61, 24, 19, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 2, '-');
INSERT INTO `lab_order_detail` VALUES (62, 24, 24, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 2, '-');
INSERT INTO `lab_order_detail` VALUES (63, 25, 18, '10', '-', '2018-10-09 03:34:38', 1, '2018-10-09 03:35:17', 1, NULL, NULL, NULL, NULL, 1, 0, 60, 1, 0, 4, '15');
INSERT INTO `lab_order_detail` VALUES (64, 25, 19, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 2, '-');
INSERT INTO `lab_order_detail` VALUES (65, 25, 24, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 2, '-');
INSERT INTO `lab_order_detail` VALUES (66, 26, 3, '20', '-', '2018-10-12 06:59:52', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 3, 'null');
INSERT INTO `lab_order_detail` VALUES (67, 26, 4, '10', '-', '2018-10-12 06:59:52', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 3, 'null');
INSERT INTO `lab_order_detail` VALUES (68, 26, 6, '42', '-', '2018-10-12 06:59:53', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 3, 'null');
INSERT INTO `lab_order_detail` VALUES (69, 26, 18, '15', '-', '2018-10-12 06:59:53', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 3, 'null');
INSERT INTO `lab_order_detail` VALUES (70, 26, 19, '30', '-', '2018-10-12 06:59:53', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 3, 'null');
INSERT INTO `lab_order_detail` VALUES (71, 26, 24, '10', '-', '2018-10-12 06:59:53', 1, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 60, 1, 0, 3, 'null');

-- ----------------------------
-- Table structure for lab_order_main
-- ----------------------------
DROP TABLE IF EXISTS `lab_order_main`;
CREATE TABLE `lab_order_main`  (
  `id_lab_order_main` int(11) NOT NULL AUTO_INCREMENT,
  `lab_order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `VN` int(11) NULL DEFAULT NULL,
  `date_ts` datetime(0) NULL DEFAULT NULL,
  `id_department` int(11) NULL DEFAULT NULL,
  `id_service_plan` int(11) NULL DEFAULT NULL,
  `id_clinic` int(11) NULL DEFAULT NULL,
  `id_patient` int(11) NULL DEFAULT NULL,
  `id_doctor` int(11) NULL DEFAULT NULL,
  `id_sevice_point` int(11) NULL DEFAULT NULL,
  `id_user` int(11) NULL DEFAULT NULL,
  `temperature` double NULL DEFAULT NULL,
  `bp_low` double NULL DEFAULT NULL,
  `bp_high` double NULL DEFAULT NULL,
  `pulse` double NULL DEFAULT NULL,
  `order_date` datetime(0) NULL DEFAULT NULL,
  `order_id_user` int(11) NULL DEFAULT NULL,
  `receive_date` datetime(0) NULL DEFAULT NULL,
  `receive_id_user` int(11) NULL DEFAULT NULL,
  `correct_date` datetime(0) NULL DEFAULT NULL,
  `correct_id_user` int(11) NULL DEFAULT NULL,
  `id_appointment` int(11) NULL DEFAULT NULL,
  `price` double NULL DEFAULT NULL,
  `total_price` double NULL DEFAULT NULL,
  `discount` double NULL DEFAULT NULL,
  `status` int(11) NULL DEFAULT 0,
  `stdel` int(11) NULL DEFAULT 0,
  `id_lab_form` int(11) NULL DEFAULT NULL,
  `id_ward` int(11) NULL DEFAULT NULL,
  `note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_hospital_send` int(11) NULL DEFAULT NULL,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_lab_order_main`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lab_order_main
-- ----------------------------
INSERT INTO `lab_order_main` VALUES (1, '00000125', 1, '2018-09-13 10:55:55', 2, 1, 1, 1, 3, 1, 1, 30.5, 75, 110, 80, '2018-09-13 10:57:38', 1, '2018-09-13 10:57:45', 1, '2018-09-13 10:57:49', 1, NULL, 1000, 1000, 0, 4, 0, NULL, 1, 'ทดสอบ', 1, 1);
INSERT INTO `lab_order_main` VALUES (2, '00000126', 2, '2018-09-13 10:59:02', 2, 2, 2, 2, 2, 1, 1, 20, 52, 111, 60, '2018-09-13 10:59:25', 1, '2018-09-13 10:59:32', 1, '2018-09-13 10:59:35', 1, NULL, 2000, 1500, 500, 1, 0, NULL, 2, 'TEST', NULL, 1);
INSERT INTO `lab_order_main` VALUES (23, '00000133', NULL, NULL, 3, 3, 2, 1, 1, 1, 1, NULL, NULL, NULL, NULL, '2018-09-21 07:46:44', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, NULL, 1, NULL, 1, 1);
INSERT INTO `lab_order_main` VALUES (24, '00000134', NULL, NULL, 1, 1, 2, 2, 1, 1, 1, NULL, NULL, NULL, NULL, '2018-09-27 03:11:27', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, NULL, 3, NULL, 1, 1);
INSERT INTO `lab_order_main` VALUES (25, '00000135', NULL, NULL, 1, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL, NULL, '2018-09-27 07:36:31', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, NULL, 1, NULL, 1, 1);
INSERT INTO `lab_order_main` VALUES (26, '00000136', NULL, NULL, 1, 1, 1, 1, 1, 1, 1, NULL, NULL, NULL, NULL, '2018-10-12 06:59:18', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 0, NULL, 2, NULL, 1, 1);

-- ----------------------------
-- Table structure for lab_result_photo_detail
-- ----------------------------
DROP TABLE IF EXISTS `lab_result_photo_detail`;
CREATE TABLE `lab_result_photo_detail`  (
  `id_number_photo` int(11) NOT NULL AUTO_INCREMENT,
  `id_lab_order_main` int(11) NULL DEFAULT NULL,
  `filename` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_number_photo`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lab_result_photo_detail
-- ----------------------------
INSERT INTO `lab_result_photo_detail` VALUES (1, 15, '4', '1234567');
INSERT INTO `lab_result_photo_detail` VALUES (2, 15, '5', 'test');
INSERT INTO `lab_result_photo_detail` VALUES (3, 16, '1', '123456');
INSERT INTO `lab_result_photo_detail` VALUES (4, 1, '1', 'test');
INSERT INTO `lab_result_photo_detail` VALUES (5, 1, '2', NULL);
INSERT INTO `lab_result_photo_detail` VALUES (6, 1, '3', 'test1');
INSERT INTO `lab_result_photo_detail` VALUES (7, 23, '1', 'ทดสอบ');
INSERT INTO `lab_result_photo_detail` VALUES (8, 23, '2', 'ทเสอบ');
INSERT INTO `lab_result_photo_detail` VALUES (9, 1, '1', NULL);

-- ----------------------------
-- Table structure for lab_specimen_item_master
-- ----------------------------
DROP TABLE IF EXISTS `lab_specimen_item_master`;
CREATE TABLE `lab_specimen_item_master`  (
  `id_lab_specimen_item` int(11) NOT NULL AUTO_INCREMENT,
  `lab_specimen_item_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lab_specimen_item_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `lab_specimen_item_note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_lab_specimen_item`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lab_specimen_item_master
-- ----------------------------
INSERT INTO `lab_specimen_item_master` VALUES (1, 'Sputum', 'A1', '', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (2, 'Throat swap', 'A2', ' ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (3, 'Blood Serum', 'B1', ' ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (4, 'bone marrow', 'B2', ' ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (5, 'CSF', 'C1', ' ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (6, 'ทดสอบ', 'ทดสอบ', 'ทดสอบ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (7, 'ทดสอบ', 'ทดสอบ', 'ทดสอบ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (8, 'ทดสอบ', 'ทดสอบ', 'ทดสอบ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (9, 'ทดสอบ', 'ทดสอบ', 'ทดสอบ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (10, 'ทดสอบ', 'ทดสอบ', 'ทดสอบ', 0, 1);
INSERT INTO `lab_specimen_item_master` VALUES (11, 'sdfdsfds', 'sdfsdfsd', 'sdfdsf', 0, 1);

-- ----------------------------
-- Table structure for lab_sub_group_item_master
-- ----------------------------
DROP TABLE IF EXISTS `lab_sub_group_item_master`;
CREATE TABLE `lab_sub_group_item_master`  (
  `id_lab_sub_group_item` int(11) NOT NULL AUTO_INCREMENT,
  `lab_sub_group_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lab_sub_group_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_lab_sub_group_item`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of lab_sub_group_item_master
-- ----------------------------
INSERT INTO `lab_sub_group_item_master` VALUES (1, 'CBC', 'LAB0001', NULL, 0, 1);
INSERT INTO `lab_sub_group_item_master` VALUES (2, 'Blood coagulation', 'LAB0002', NULL, 0, 1);
INSERT INTO `lab_sub_group_item_master` VALUES (3, 'Electrolyte', 'LAB0003', NULL, 0, 1);
INSERT INTO `lab_sub_group_item_master` VALUES (4, 'Liver Function Test', 'LAB0004', NULL, 0, 2);
INSERT INTO `lab_sub_group_item_master` VALUES (5, 'Creatinine', 'LAB0005', NULL, 0, 2);

-- ----------------------------
-- Table structure for menu_master_data
-- ----------------------------
...
CREATE TABLE `menu_master_data`  (
  ...
  `menu_tag` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_menu_data`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 21 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of menu_master_data
-- ----------------------------
INSERT INTO `menu_master_data` VALUES (1, 'รับสิ่งส่งตรวจ', '1');
INSERT INTO `menu_master_data` VALUES (2, 'ลงผลตรวจ', '2');
INSERT INTO `menu_master_data` VALUES (3, 'ย้อนดูผลตรวจ', '3');
INSERT INTO `menu_master_data` VALUES (4, 'สำเนาผลตรวจ', '4');
INSERT INTO `menu_master_data` VALUES (5, 'ผลตรวจรูปภาพ', '5');
INSERT INTO `menu_master_data` VALUES (6, 'เปลี่ยนรหัสผ่าน', '6');
INSERT INTO `menu_master_data` VALUES (7, 'จัดการผู้ใช้', '7');
INSERT INTO `menu_master_data` VALUES (8, 'จัดการข้อมูล', '8');
INSERT INTO `menu_master_data` VALUES (9, 'จัดการเมนู', '9');
INSERT INTO `menu_master_data` VALUES (10, 'อัพโหลดไฟล์', '10');
INSERT INTO `menu_master_data` VALUES (11, 'config', '11');
INSERT INTO `menu_master_data` VALUES (12, 'itemcode', '12');
INSERT INTO `menu_master_data` VALUES (13, 'logfile', '13');
INSERT INTO `menu_master_data` VALUES (14, 'login', '14');
INSERT INTO `menu_master_data` VALUES (15, 'qcconfig', '15');
INSERT INTO `menu_master_data` VALUES (16, 'qcinput', '16');
INSERT INTO `menu_master_data` VALUES (17, 'qcsetup', '17');
INSERT INTO `menu_master_data` VALUES (18, 'qcviewer', '18');
INSERT INTO `menu_master_data` VALUES (19, 'รายงานhis', '19');
INSERT INTO `menu_master_data` VALUES (20, 'รายงานtis', '20');

-- ----------------------------
-- Table structure for menu_relate_user_group
-- ----------------------------
DROP TABLE IF EXISTS `menu_relate_user_group`;
CREATE TABLE `menu_relate_user_group`  (
  `id_relate` int(11) NOT NULL AUTO_INCREMENT,
  `id_user_group` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_menu` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_relate`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 38 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of menu_relate_user_group
-- ----------------------------
INSERT INTO `menu_relate_user_group` VALUES (1, '1', 1);
INSERT INTO `menu_relate_user_group` VALUES (2, '1', 2);
INSERT INTO `menu_relate_user_group` VALUES (3, '1', 3);
INSERT INTO `menu_relate_user_group` VALUES (4, '2', 3);
INSERT INTO `menu_relate_user_group` VALUES (5, '1', 4);
INSERT INTO `menu_relate_user_group` VALUES (6, '1', 5);
INSERT INTO `menu_relate_user_group` VALUES (7, '1', 6);
INSERT INTO `menu_relate_user_group` VALUES (8, '1', 7);
INSERT INTO `menu_relate_user_group` VALUES (9, '1', 8);
INSERT INTO `menu_relate_user_group` VALUES (10, '1', 9);
INSERT INTO `menu_relate_user_group` VALUES (11, '1', 10);
INSERT INTO `menu_relate_user_group` VALUES (12, '1', 11);
INSERT INTO `menu_relate_user_group` VALUES (13, '1', 12);
INSERT INTO `menu_relate_user_group` VALUES (14, '1', 13);
INSERT INTO `menu_relate_user_group` VALUES (15, '1', 14);
INSERT INTO `menu_relate_user_group` VALUES (16, '1', 15);
INSERT INTO `menu_relate_user_group` VALUES (17, '1', 16);
INSERT INTO `menu_relate_user_group` VALUES (18, '1', 17);
INSERT INTO `menu_relate_user_group` VALUES (19, '1', 18);
INSERT INTO `menu_relate_user_group` VALUES (20, '1', 19);
INSERT INTO `menu_relate_user_group` VALUES (21, '1', 20);
INSERT INTO `menu_relate_user_group` VALUES (23, '2', 1);
INSERT INTO `menu_relate_user_group` VALUES (24, '2', 2);
INSERT INTO `menu_relate_user_group` VALUES (25, '2', 5);
INSERT INTO `menu_relate_user_group` VALUES (26, '2', 6);
INSERT INTO `menu_relate_user_group` VALUES (27, '2', 7);
INSERT INTO `menu_relate_user_group` VALUES (28, '2', 9);
INSERT INTO `menu_relate_user_group` VALUES (29, '2', 13);
INSERT INTO `menu_relate_user_group` VALUES (30, '2', 14);
INSERT INTO `menu_relate_user_group` VALUES (31, '2', 2);
INSERT INTO `menu_relate_user_group` VALUES (32, '2', 5);
INSERT INTO `menu_relate_user_group` VALUES (33, '2', 6);
INSERT INTO `menu_relate_user_group` VALUES (34, '2', 7);
INSERT INTO `menu_relate_user_group` VALUES (35, '2', 9);
INSERT INTO `menu_relate_user_group` VALUES (36, '2', 13);
INSERT INTO `menu_relate_user_group` VALUES (37, '2', 14);
...
-- ----------------------------
-- Table structure for nationality_master
-- ----------------------------
DROP TABLE IF EXISTS `nationality_master`;
CREATE TABLE `nationality_master`  (
  `id_nationality` int(11) NOT NULL AUTO_INCREMENT,
  `nationality_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_nationality`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 272 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of nationality_master
-- ----------------------------
INSERT INTO `nationality_master` VALUES (1, '', 0);
INSERT INTO `nationality_master` VALUES (2, 'ชื่อเชื้อชาติ/สัญชาติ', 0);
INSERT INTO `nationality_master` VALUES (3, 'โปรตุเกส', 0);
INSERT INTO `nationality_master` VALUES (4, 'ดัตช์', 0);
INSERT INTO `nationality_master` VALUES (5, 'เยอรมัน', 0);
INSERT INTO `nationality_master` VALUES (6, 'ฝรั่งเศส', 0);
INSERT INTO `nationality_master` VALUES (7, 'เดนมาร์ก', 0);
INSERT INTO `nationality_master` VALUES (8, 'สวีเดน', 0);
INSERT INTO `nationality_master` VALUES (9, 'สวิส', 0);
INSERT INTO `nationality_master` VALUES (10, 'อิตาลี', 0);
INSERT INTO `nationality_master` VALUES (11, 'นอร์เวย์', 0);
INSERT INTO `nationality_master` VALUES (12, 'ออสเตรีย', 0);
INSERT INTO `nationality_master` VALUES (13, 'ไอริช', 0);
INSERT INTO `nationality_master` VALUES (14, 'ฟินแลนด์', 0);
INSERT INTO `nationality_master` VALUES (15, 'เบลเยียม', 0);
INSERT INTO `nationality_master` VALUES (16, 'สเปน', 0);
INSERT INTO `nationality_master` VALUES (17, 'รัสเซีย', 0);
INSERT INTO `nationality_master` VALUES (18, 'โปแลนด์', 0);
INSERT INTO `nationality_master` VALUES (19, 'เช็ก', 0);
INSERT INTO `nationality_master` VALUES (20, 'ฮังการี', 0);
INSERT INTO `nationality_master` VALUES (21, 'กรีก', 0);
INSERT INTO `nationality_master` VALUES (22, 'ยูโกสลาฟ', 0);
INSERT INTO `nationality_master` VALUES (23, 'ลักเซมเบิร์ก', 0);
INSERT INTO `nationality_master` VALUES (24, 'วาติกัน', 0);
INSERT INTO `nationality_master` VALUES (25, 'มอลตา', 0);
INSERT INTO `nationality_master` VALUES (26, 'ลีซู', 0);
INSERT INTO `nationality_master` VALUES (27, 'บัลแกเรีย', 0);
INSERT INTO `nationality_master` VALUES (28, 'โรมาเนีย', 0);
INSERT INTO `nationality_master` VALUES (29, 'ไซปรัส', 0);
INSERT INTO `nationality_master` VALUES (30, 'อเมริกัน', 0);
INSERT INTO `nationality_master` VALUES (31, 'แคนาดา', 0);
INSERT INTO `nationality_master` VALUES (32, 'เม็กซิโก', 0);
INSERT INTO `nationality_master` VALUES (33, 'คิวบา', 0);
INSERT INTO `nationality_master` VALUES (34, 'อาร์เจนตินา', 0);
INSERT INTO `nationality_master` VALUES (35, 'บราซิล', 0);
INSERT INTO `nationality_master` VALUES (36, 'ชิลี', 0);
INSERT INTO `nationality_master` VALUES (37, 'อาข่า', 0);
INSERT INTO `nationality_master` VALUES (38, 'โคลัมเบีย', 0);
INSERT INTO `nationality_master` VALUES (39, 'ลั๊ว', 0);
INSERT INTO `nationality_master` VALUES (40, 'เปรู', 0);
INSERT INTO `nationality_master` VALUES (41, 'ปานามา', 0);
INSERT INTO `nationality_master` VALUES (42, 'อุรุกวัย', 0);
INSERT INTO `nationality_master` VALUES (43, 'เวเนซุเอลา', 0);
INSERT INTO `nationality_master` VALUES (44, 'เปอร์โตริโก้', 0);
INSERT INTO `nationality_master` VALUES (45, 'จีน', 0);
INSERT INTO `nationality_master` VALUES (46, 'อินเดีย', 0);
INSERT INTO `nationality_master` VALUES (47, 'เวียดนาม', 0);
INSERT INTO `nationality_master` VALUES (48, 'ญี่ปุ่น', 0);
INSERT INTO `nationality_master` VALUES (49, 'พม่า', 0);
INSERT INTO `nationality_master` VALUES (50, 'ฟิลิปปิน', 0);
INSERT INTO `nationality_master` VALUES (51, 'มาเลเซีย', 0);
INSERT INTO `nationality_master` VALUES (52, 'อินโดนีเซีย', 0);
INSERT INTO `nationality_master` VALUES (53, 'ปากีสถาน', 0);
INSERT INTO `nationality_master` VALUES (54, 'เกาหลีใต้', 0);
INSERT INTO `nationality_master` VALUES (55, 'สิงคโปร์', 0);
INSERT INTO `nationality_master` VALUES (56, 'เนปาล', 0);
INSERT INTO `nationality_master` VALUES (57, 'ลาว', 0);
INSERT INTO `nationality_master` VALUES (58, 'กัมพูชา', 0);
INSERT INTO `nationality_master` VALUES (59, 'ศรีลังกา', 0);
INSERT INTO `nationality_master` VALUES (60, 'ซาอุดีอาระเบีย', 0);
INSERT INTO `nationality_master` VALUES (61, 'อิสราเอล', 0);
INSERT INTO `nationality_master` VALUES (62, 'เลบานอน', 0);
INSERT INTO `nationality_master` VALUES (63, 'อิหร่าน', 0);
INSERT INTO `nationality_master` VALUES (64, 'ตุรกี', 0);
INSERT INTO `nationality_master` VALUES (65, 'บังกลาเทศ', 0);
INSERT INTO `nationality_master` VALUES (66, 'ถูกถอนสัญชาติ', 0);
INSERT INTO `nationality_master` VALUES (67, 'ซีเรีย', 0);
INSERT INTO `nationality_master` VALUES (68, 'อิรัก', 0);
INSERT INTO `nationality_master` VALUES (69, 'คูเวต', 0);
INSERT INTO `nationality_master` VALUES (70, 'บรูไน', 0);
INSERT INTO `nationality_master` VALUES (71, 'แอฟริกาใต้', 0);
INSERT INTO `nationality_master` VALUES (72, 'กะเหรี่ยง', 0);
INSERT INTO `nationality_master` VALUES (73, 'ลาหู่', 0);
INSERT INTO `nationality_master` VALUES (74, 'เคนยา', 0);
INSERT INTO `nationality_master` VALUES (75, 'อียิปต์', 0);
INSERT INTO `nationality_master` VALUES (76, 'เอธิโอเปีย', 0);
INSERT INTO `nationality_master` VALUES (77, 'ไนจีเรีย', 0);
INSERT INTO `nationality_master` VALUES (78, 'สหรัฐอาหรับเอมิเรตส์', 0);
INSERT INTO `nationality_master` VALUES (79, 'กินี', 0);
INSERT INTO `nationality_master` VALUES (80, 'ออสเตรเลีย', 0);
INSERT INTO `nationality_master` VALUES (81, 'นิวซีแลนด์', 0);
INSERT INTO `nationality_master` VALUES (82, 'ปาปัวนิวกินี', 0);
INSERT INTO `nationality_master` VALUES (83, 'ม้ง', 0);
INSERT INTO `nationality_master` VALUES (84, 'เมี่ยน', 0);
INSERT INTO `nationality_master` VALUES (85, 'ชาวเขาที่ไม่ได้รับสัญขาติไทย', 0);
INSERT INTO `nationality_master` VALUES (86, '-', 0);
INSERT INTO `nationality_master` VALUES (87, 'จีนฮ่อ', 0);
INSERT INTO `nationality_master` VALUES (88, 'จีน (อดีตทหารจีนคณะชาติ ,อดีตทหารจีนชาติ)', 0);
INSERT INTO `nationality_master` VALUES (89, 'ผู้พลัดถิ่นสัญชาติพม่า', 0);
INSERT INTO `nationality_master` VALUES (90, 'ผู้อพยพเชื้อสายจากกัมพูชา', 0);
INSERT INTO `nationality_master` VALUES (91, 'ลาว (ลาวอพยพ)', 0);
INSERT INTO `nationality_master` VALUES (92, 'เขมรอพยพ', 0);
INSERT INTO `nationality_master` VALUES (93, 'ผู้อพยพอินโดจีนสัญชาติเวียดนาม', 0);
INSERT INTO `nationality_master` VALUES (94, 'รอให้สัญชาติไทย', 0);
INSERT INTO `nationality_master` VALUES (95, 'ไทย-อิสลาม,อิสลาม-ไทย', 0);
INSERT INTO `nationality_master` VALUES (96, 'ไทย-จีน,จีน-ไทย', 0);
INSERT INTO `nationality_master` VALUES (97, 'ไร้สัญชาติ', 0);
INSERT INTO `nationality_master` VALUES (98, 'อื่นๆ', 0);
INSERT INTO `nationality_master` VALUES (99, 'ไม่ได้สัญชาติไทย', 0);
INSERT INTO `nationality_master` VALUES (100, 'ไทย', 0);
INSERT INTO `nationality_master` VALUES (101, 'อัฟกัน', 0);
INSERT INTO `nationality_master` VALUES (102, 'บาห์เรน', 0);
INSERT INTO `nationality_master` VALUES (103, 'ภูฏาน', 0);
INSERT INTO `nationality_master` VALUES (104, 'จอร์แดน', 0);
INSERT INTO `nationality_master` VALUES (105, 'เกาหลีเหนือ', 0);
INSERT INTO `nationality_master` VALUES (106, 'มัลดีฟ', 0);
INSERT INTO `nationality_master` VALUES (107, 'มองโกเลีย', 0);
INSERT INTO `nationality_master` VALUES (108, 'โอมาน', 0);
INSERT INTO `nationality_master` VALUES (109, 'กาตาร์', 0);
INSERT INTO `nationality_master` VALUES (110, 'เยเมน', 0);
INSERT INTO `nationality_master` VALUES (111, 'เยเมน(ใต้)**', 0);
INSERT INTO `nationality_master` VALUES (112, 'หมู่เกาะฟิจิ', 0);
INSERT INTO `nationality_master` VALUES (113, 'คิริบาส', 0);
INSERT INTO `nationality_master` VALUES (114, 'นาอูรู', 0);
INSERT INTO `nationality_master` VALUES (115, 'หมู่เกาะโซโลมอน', 0);
INSERT INTO `nationality_master` VALUES (116, 'ตองก้า', 0);
INSERT INTO `nationality_master` VALUES (117, 'ตูวาลู', 0);
INSERT INTO `nationality_master` VALUES (118, 'วานูอาตู', 0);
INSERT INTO `nationality_master` VALUES (119, 'ซามัว', 0);
INSERT INTO `nationality_master` VALUES (120, 'แอลเบเนีย', 0);
INSERT INTO `nationality_master` VALUES (121, 'อันดอร์รา', 0);
INSERT INTO `nationality_master` VALUES (122, 'เยอรมนีตะวันออก**', 0);
INSERT INTO `nationality_master` VALUES (123, 'ไอซ์แลนด์', 0);
INSERT INTO `nationality_master` VALUES (124, 'ลิกเตนสไตน์', 0);
INSERT INTO `nationality_master` VALUES (125, 'โมนาโก', 0);
INSERT INTO `nationality_master` VALUES (126, 'ซานมารีโน', 0);
INSERT INTO `nationality_master` VALUES (127, 'บริติช  (อังกฤษ, สก็อตแลนด์)', 0);
INSERT INTO `nationality_master` VALUES (128, 'แอลจีเรีย', 0);
INSERT INTO `nationality_master` VALUES (129, 'แองโกลา', 0);
INSERT INTO `nationality_master` VALUES (130, 'เบนิน', 0);
INSERT INTO `nationality_master` VALUES (131, 'บอตสวานา', 0);
INSERT INTO `nationality_master` VALUES (132, 'บูร์กินาฟาโซ', 0);
INSERT INTO `nationality_master` VALUES (133, 'บุรุนดี', 0);
INSERT INTO `nationality_master` VALUES (134, 'แคเมอรูน', 0);
INSERT INTO `nationality_master` VALUES (135, 'เคปเวิร์ด', 0);
INSERT INTO `nationality_master` VALUES (136, 'แอฟริกากลาง', 0);
INSERT INTO `nationality_master` VALUES (137, 'ชาด', 0);
INSERT INTO `nationality_master` VALUES (138, 'คอสตาริกา', 0);
INSERT INTO `nationality_master` VALUES (139, 'คองโก', 0);
INSERT INTO `nationality_master` VALUES (140, 'ไอโวเรี่ยน', 0);
INSERT INTO `nationality_master` VALUES (141, 'จิบูตี', 0);
INSERT INTO `nationality_master` VALUES (142, 'อิเควทอเรียลกินี', 0);
INSERT INTO `nationality_master` VALUES (143, 'กาบอง', 0);
INSERT INTO `nationality_master` VALUES (144, 'แกมเบีย', 0);
INSERT INTO `nationality_master` VALUES (145, 'กานา', 0);
INSERT INTO `nationality_master` VALUES (146, 'กินีบีสเซา', 0);
INSERT INTO `nationality_master` VALUES (147, 'เลโซโท', 0);
INSERT INTO `nationality_master` VALUES (148, 'ไลบีเรีย', 0);
INSERT INTO `nationality_master` VALUES (149, 'ลิเบีย', 0);
INSERT INTO `nationality_master` VALUES (150, 'มาลากาซี', 0);
INSERT INTO `nationality_master` VALUES (151, 'มาลาวี', 0);
INSERT INTO `nationality_master` VALUES (152, 'มาลี', 0);
INSERT INTO `nationality_master` VALUES (153, 'มอริเตเนีย', 0);
INSERT INTO `nationality_master` VALUES (154, 'มอริเชียส', 0);
INSERT INTO `nationality_master` VALUES (155, 'โมร็อกโก', 0);
INSERT INTO `nationality_master` VALUES (156, 'โมซัมบิก', 0);
INSERT INTO `nationality_master` VALUES (157, 'ไนเจอร์', 0);
INSERT INTO `nationality_master` VALUES (158, 'รวันดา', 0);
INSERT INTO `nationality_master` VALUES (159, 'เซาโตเมและปรินซิเป', 0);
INSERT INTO `nationality_master` VALUES (160, 'เซเนกัล', 0);
INSERT INTO `nationality_master` VALUES (161, 'เซเชลส์', 0);
INSERT INTO `nationality_master` VALUES (162, 'เซียร์ราลีโอน', 0);
INSERT INTO `nationality_master` VALUES (163, 'โซมาลี', 0);
INSERT INTO `nationality_master` VALUES (164, 'ซูดาน', 0);
INSERT INTO `nationality_master` VALUES (165, 'สวาซี', 0);
INSERT INTO `nationality_master` VALUES (166, 'แทนซาเนีย', 0);
INSERT INTO `nationality_master` VALUES (167, 'โตโก', 0);
INSERT INTO `nationality_master` VALUES (168, 'ตูนิเซีย', 0);
INSERT INTO `nationality_master` VALUES (169, 'ยูกันดา', 0);
INSERT INTO `nationality_master` VALUES (170, 'ซาอีร์', 0);
INSERT INTO `nationality_master` VALUES (171, 'แซมเบีย', 0);
INSERT INTO `nationality_master` VALUES (172, 'ซิมบับเว', 0);
INSERT INTO `nationality_master` VALUES (173, 'แอนติกาและบาร์บูดา', 0);
INSERT INTO `nationality_master` VALUES (174, 'บาฮามาส', 0);
INSERT INTO `nationality_master` VALUES (175, 'บาร์เบโดส', 0);
INSERT INTO `nationality_master` VALUES (176, 'เบลิซ', 0);
INSERT INTO `nationality_master` VALUES (177, 'คอสตาริกา', 0);
INSERT INTO `nationality_master` VALUES (178, 'โดมินิกา', 0);
INSERT INTO `nationality_master` VALUES (179, 'โดมินิกัน', 0);
INSERT INTO `nationality_master` VALUES (180, 'เอลซัลวาดอร์', 0);
INSERT INTO `nationality_master` VALUES (181, 'เกรเนดา', 0);
INSERT INTO `nationality_master` VALUES (182, 'กัวเตมาลา', 0);
INSERT INTO `nationality_master` VALUES (183, 'เฮติ', 0);
INSERT INTO `nationality_master` VALUES (184, 'ฮอนดูรัส', 0);
INSERT INTO `nationality_master` VALUES (185, 'จาเมกา', 0);
INSERT INTO `nationality_master` VALUES (186, 'นิการากัว', 0);
INSERT INTO `nationality_master` VALUES (187, 'เซนต์คิตส์และเนวิส', 0);
INSERT INTO `nationality_master` VALUES (188, 'เซนต์ลูเซีย', 0);
INSERT INTO `nationality_master` VALUES (189, 'เซนต์วินเซนต์และเกรนาดีนส์', 0);
INSERT INTO `nationality_master` VALUES (190, 'ตรินิแดดและโตเบโก', 0);
INSERT INTO `nationality_master` VALUES (191, 'โบลีเวีย', 0);
INSERT INTO `nationality_master` VALUES (192, 'เอกวาดอร์', 0);
INSERT INTO `nationality_master` VALUES (193, 'กายอานา', 0);
INSERT INTO `nationality_master` VALUES (194, 'ปารากวัย', 0);
INSERT INTO `nationality_master` VALUES (195, 'ซูรินาเม', 0);
INSERT INTO `nationality_master` VALUES (196, 'อาหรับ', 0);
INSERT INTO `nationality_master` VALUES (197, 'คะฉิ่น', 0);
INSERT INTO `nationality_master` VALUES (198, 'ว้า', 0);
INSERT INTO `nationality_master` VALUES (199, 'ไทยใหญ่', 0);
INSERT INTO `nationality_master` VALUES (200, 'ไทยลื้อ', 0);
INSERT INTO `nationality_master` VALUES (201, 'ขมุ', 0);
INSERT INTO `nationality_master` VALUES (202, 'ตองสู', 0);
INSERT INTO `nationality_master` VALUES (203, 'เงี้ยว**', 0);
INSERT INTO `nationality_master` VALUES (204, 'ละว้า', 0);
INSERT INTO `nationality_master` VALUES (205, 'แม้ว', 0);
INSERT INTO `nationality_master` VALUES (206, 'ปะหร่อง', 0);
INSERT INTO `nationality_master` VALUES (207, 'ถิ่น', 0);
INSERT INTO `nationality_master` VALUES (208, 'ปะโอ', 0);
INSERT INTO `nationality_master` VALUES (209, 'มอญ', 0);
INSERT INTO `nationality_master` VALUES (210, 'มลาบรี', 0);
INSERT INTO `nationality_master` VALUES (211, 'เฮาะ**', 0);
INSERT INTO `nationality_master` VALUES (212, 'สก็อตแลน์**', 0);
INSERT INTO `nationality_master` VALUES (213, 'จีน (จีนฮ่ออิสระ)', 0);
INSERT INTO `nationality_master` VALUES (214, 'จีนอพยพ**', 0);
INSERT INTO `nationality_master` VALUES (215, 'จีน (จีนฮ่ออพยพ)', 0);
INSERT INTO `nationality_master` VALUES (216, 'ไต้หวัน**', 0);
INSERT INTO `nationality_master` VALUES (217, 'ยูเครน', 0);
INSERT INTO `nationality_master` VALUES (218, 'อาณานิคมอังกฤษ**', 0);
INSERT INTO `nationality_master` VALUES (219, 'ดูไบ**', 0);
INSERT INTO `nationality_master` VALUES (220, 'จีน(ฮ่องกง)', 0);
INSERT INTO `nationality_master` VALUES (221, 'จีน(ไต้หวัน)', 0);
INSERT INTO `nationality_master` VALUES (222, 'โครเอเชีย', 0);
INSERT INTO `nationality_master` VALUES (223, 'คาซัค', 0);
INSERT INTO `nationality_master` VALUES (224, 'บริทิธ**', 0);
INSERT INTO `nationality_master` VALUES (225, 'อาร์เมเนีย', 0);
INSERT INTO `nationality_master` VALUES (226, 'อาเซอร์ไบจาน', 0);
INSERT INTO `nationality_master` VALUES (227, 'จอร์เจีย', 0);
INSERT INTO `nationality_master` VALUES (228, 'คีร์กีซ', 0);
INSERT INTO `nationality_master` VALUES (229, 'ทาจิก', 0);
INSERT INTO `nationality_master` VALUES (230, 'อุซเบก', 0);
INSERT INTO `nationality_master` VALUES (231, 'หมู่เกาะมาร์แชลล์', 0);
INSERT INTO `nationality_master` VALUES (232, 'ไมโครนีเซีย', 0);
INSERT INTO `nationality_master` VALUES (233, 'ปาเลา', 0);
INSERT INTO `nationality_master` VALUES (234, 'เบลารุส', 0);
INSERT INTO `nationality_master` VALUES (235, 'บอสเนียและเฮอร์เซโกวีนา', 0);
INSERT INTO `nationality_master` VALUES (236, 'เติร์กเมน', 0);
INSERT INTO `nationality_master` VALUES (237, 'เอสโตเนีย', 0);
INSERT INTO `nationality_master` VALUES (238, 'ลัตเวีย', 0);
INSERT INTO `nationality_master` VALUES (239, 'ลิทัวเนีย', 0);
INSERT INTO `nationality_master` VALUES (240, 'มาซิโดเนีย', 0);
INSERT INTO `nationality_master` VALUES (241, 'มอลโดวา', 0);
INSERT INTO `nationality_master` VALUES (242, 'สโลวัก', 0);
INSERT INTO `nationality_master` VALUES (243, 'สโลวีน', 0);
INSERT INTO `nationality_master` VALUES (244, 'เอริเทรีย', 0);
INSERT INTO `nationality_master` VALUES (245, 'นามิเบีย', 0);
INSERT INTO `nationality_master` VALUES (246, 'โบลิเวีย', 0);
INSERT INTO `nationality_master` VALUES (247, 'หมู่เกาะคุก', 0);
INSERT INTO `nationality_master` VALUES (248, 'เนปาล (เนปาลอพยพ)', 0);
INSERT INTO `nationality_master` VALUES (249, 'มอญ  (ผู้พลัดถิ่นสัญชาติพม่า)', 0);
INSERT INTO `nationality_master` VALUES (250, 'ไทยใหญ่  (ผู้พลัดถิ่นสัญชาติพม่า)', 0);
INSERT INTO `nationality_master` VALUES (251, 'เวียดนาม  (ญวนอพยพ)', 0);
INSERT INTO `nationality_master` VALUES (252, 'มาเลเชีย  (อดีต จีนคอมมิวนิสต์)', 0);
INSERT INTO `nationality_master` VALUES (253, 'จีน  (อดีต จีนคอมมิวนิสต์)', 0);
INSERT INTO `nationality_master` VALUES (254, 'สิงคโปร์  (อดีต จีนคอมมิวนิสต์)', 0);
INSERT INTO `nationality_master` VALUES (255, 'กะเหรี่ยง  (ผู้หลบหนีเข้าเมือง)', 0);
INSERT INTO `nationality_master` VALUES (256, 'มอญ  (ผู้หลบหนีเข้าเมือง)', 0);
INSERT INTO `nationality_master` VALUES (257, 'ไทยใหญ่  (ผู้หลบหนีเข้าเมือง)', 0);
INSERT INTO `nationality_master` VALUES (258, 'กัมพูชา  (ผู้หลบหนีเข้าเมือง)', 0);
INSERT INTO `nationality_master` VALUES (259, 'มอญ  (ชุมชนบนพื้นที่สูง)', 0);
INSERT INTO `nationality_master` VALUES (260, 'กะเหรี่ยง  (ชุมชนบนพื้นที่สูง)', 0);
INSERT INTO `nationality_master` VALUES (261, 'ปาเลสไตน์', 0);
INSERT INTO `nationality_master` VALUES (262, 'ติมอร์ตะวันออก', 0);
INSERT INTO `nationality_master` VALUES (263, 'สละสัญชาติไทย', 0);
INSERT INTO `nationality_master` VALUES (264, 'เซอร์เบีย แอนด์ มอนเตเนโกร', 0);
INSERT INTO `nationality_master` VALUES (265, 'กัมพูชา(แรงงาน)', 0);
INSERT INTO `nationality_master` VALUES (266, 'พม่า(แรงงาน)', 0);
INSERT INTO `nationality_master` VALUES (267, 'ลาว(แรงงาน)', 0);
INSERT INTO `nationality_master` VALUES (268, 'เซอร์เบียน', 0);
INSERT INTO `nationality_master` VALUES (269, 'มอนเตเนกริน', 0);
INSERT INTO `nationality_master` VALUES (270, 'บุคคลที่ไม่มีสถานะทางทะเบียน', 0);
INSERT INTO `nationality_master` VALUES (271, 'ไม่ระบุ', 0);
...
CREATE TABLE `patient_master`  (
  ...
  `patient_firstname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `patient_lastname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `prefix_name` int(11) NULL DEFAULT NULL,
  `birthday` date NULL DEFAULT NULL,
  `patient_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `patient_district` int(11) NULL DEFAULT NULL,
  `patient_amphur` int(11) NULL DEFAULT NULL,
  `patient_province` int(11) NULL DEFAULT NULL,
  `patient_zipcode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `blood_group` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ethnicity` int(11) NULL DEFAULT NULL,
  `nationality` int(11) NULL DEFAULT NULL,
  `clinic` int(11) NULL DEFAULT NULL,
  `drug_allergy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `regis_date` datetime(0) NULL DEFAULT NULL,
  `patient_tel` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `inform_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `inform_relate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `inform_tel` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `marital_status` int(11) NULL DEFAULT 0 COMMENT '1 = โสด\r\n2 = สมรส\r\n3 = หม้าย\r\n4 = หย่า\r\n5 = แยกกันอยู่',
  `patient_religion` int(11) NULL DEFAULT NULL,
  `gender` int(11) NULL DEFAULT NULL COMMENT '1 = ชาย , 2 = หญิง',
  `citizenid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `private_docter_id` int(11) NULL DEFAULT NULL,
  `patient_email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
...
-- ----------------------------
INSERT INTO `patient_master` VALUES (1, '0000000001', 'วันดี', 'วันนี้เท่านั้น', 2, '2012-01-06', '689 ถ.คีรีรัฐ', 1, 1, 1, '101010', 'A', 250, 258, NULL, 'แพ้พารา', 'อิป้อว', 'อิแม่', '2018-06-01 10:44:24', '021544421', NULL, NULL, NULL, 1, 1, 2, '1524466551245', 1, 'test@gmail.com', 0, '2018-09-01 10:45:44', 2, 56, 170.5, 1);
INSERT INTO `patient_master` VALUES (2, '0000000002', 'วันไม่ดี', 'ทุก ๆ วัน', 1, '1997-01-01', '987 ถ.สันทรายใหม่', 1, 1, 1, '10010', 'AB', 258, 258, NULL, NULL, 'พ่อ', 'แม่', '2018-09-11 11:06:11', '021542255', NULL, NULL, NULL, 1, 3, 1, '1502211446854', 1, 'test2@gmail.com', 0, '2018-09-11 11:06:41', 3, 79.5, 180, 2);
INSERT INTO `patient_master` VALUES (3, '2', 'สีนวล', 'อ้วนจัง', 4, '2018-09-01', '50 หมู่ 5', 637, 91, 6, '52000', 'O', 1, 19, NULL, 'พารา', 'มานี', 'มีนา', NULL, '54554025421', NULL, NULL, NULL, 1, 21, 2, '11111111154245', 1, 'bewkak@gmail.com', 0, NULL, 3, 150, 200, NULL);

-- ----------------------------
-- Table structure for patient_type
-- ----------------------------
DROP TABLE IF EXISTS `patient_type`;
CREATE TABLE `patient_type`  (
  `id_patient_type` int(11) NOT NULL AUTO_INCREMENT,
  `patient_type_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `patient_type_note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_patient_type`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of patient_type
-- ----------------------------
INSERT INTO `patient_type` VALUES (1, 'ผู้ป่วยนอก', NULL, 0, 1);
INSERT INTO `patient_type` VALUES (2, 'ผู้ป่วยฉุกเฉิน', NULL, 0, 1);
INSERT INTO `patient_type` VALUES (3, 'ผู้ป่วยส่งตัว', NULL, 0, 1);

-- ----------------------------
-- Table structure for position_master
-- ----------------------------
...
-- ----------------------------
-- Records of position_master
-- ----------------------------
INSERT INTO `position_master` VALUES (1, 'หัวหน้างาน', 0, 1);
INSERT INTO `position_master` VALUES (2, 'พนักงานปฏิบัติงาน', 0, 1);
INSERT INTO `position_master` VALUES (3, 'พนักงานทดลองงาน', 0, 1);
INSERT INTO `position_master` VALUES (4, 'พนักงานทำความสะอาด', 0, 1);
INSERT INTO `position_master` VALUES (28, 'กวางตุ้งๆๆๆๆๆห', 0, 1);
INSERT INTO `position_master` VALUES (27, 'กวางตุ้ง', 0, 1);
INSERT INTO `position_master` VALUES (26, 'ทดสอบ', 0, 1);

-- ----------------------------
-- Table structure for prefix_name_master
-- ----------------------------
DROP TABLE IF EXISTS `prefix_name_master`;
CREATE TABLE `prefix_name_master`  (
  `id_prefix` int(11) NOT NULL AUTO_INCREMENT,
  `prefix_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_prefix`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of prefix_name_master
-- ----------------------------
INSERT INTO `prefix_name_master` VALUES (1, 'นาย', 0);
INSERT INTO `prefix_name_master` VALUES (2, 'นาง', 0);
INSERT INTO `prefix_name_master` VALUES (3, 'นางสาว', 0);
INSERT INTO `prefix_name_master` VALUES (4, 'ดร.', 0);
INSERT INTO `prefix_name_master` VALUES (5, 'ทพ', 0);

-- ----------------------------
-- Table structure for profile_qc_item_detail
-- ----------------------------
DROP TABLE IF EXISTS `profile_qc_item_detail`;
CREATE TABLE `profile_qc_item_detail`  (
  `id_qc_profile_detail` int(11) NOT NULL AUTO_INCREMENT,
  `id_profile_qc_main` int(11) NULL DEFAULT NULL,
  `id_item_qc` int(11) NULL DEFAULT NULL,
  `mean` double(255, 0) NULL DEFAULT 0,
  `sd` double(255, 0) NULL DEFAULT 0,
  PRIMARY KEY (`id_qc_profile_detail`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;

-- ----------------------------
-- Records of profile_qc_item_detail
-- ----------------------------
INSERT INTO `profile_qc_item_detail` VALUES (1, 71, 18, 111, 10);
INSERT INTO `profile_qc_item_detail` VALUES (2, 71, 19, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (3, 71, 20, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (4, 72, 18, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (5, 72, 19, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (6, 72, 20, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (7, 73, 18, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (8, 73, 19, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (9, 73, 24, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (10, 73, 20, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (11, 73, 21, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (12, 73, 22, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (13, 73, 23, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (14, 75, 20, 20, 33);
INSERT INTO `profile_qc_item_detail` VALUES (15, 75, 21, 20, 44);
INSERT INTO `profile_qc_item_detail` VALUES (16, 75, 22, 20, 55);
INSERT INTO `profile_qc_item_detail` VALUES (17, 75, 23, 20, 66);
INSERT INTO `profile_qc_item_detail` VALUES (37, 76, 23, 80, 2);
INSERT INTO `profile_qc_item_detail` VALUES (36, 76, 22, 90, 4);
INSERT INTO `profile_qc_item_detail` VALUES (35, 76, 21, 100, 2);
INSERT INTO `profile_qc_item_detail` VALUES (34, 76, 20, 140, 1);
INSERT INTO `profile_qc_item_detail` VALUES (33, 76, 18, 130, 2);
INSERT INTO `profile_qc_item_detail` VALUES (32, 76, 19, 120, 3);
INSERT INTO `profile_qc_item_detail` VALUES (31, 76, 24, 110, 2);
INSERT INTO `profile_qc_item_detail` VALUES (28, 77, 18, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (29, 77, 19, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (30, 77, 24, 0, 0);
INSERT INTO `profile_qc_item_detail` VALUES (38, 78, 18, 50, 5);
INSERT INTO `profile_qc_item_detail` VALUES (39, 78, 19, 50, 5);
INSERT INTO `profile_qc_item_detail` VALUES (40, 78, 24, 50, 5);

-- ----------------------------
-- Table structure for profile_qc_master
-- ----------------------------
DROP TABLE IF EXISTS `profile_qc_master`;
CREATE TABLE `profile_qc_master`  (
  `id_profile_qc` int(11) NOT NULL AUTO_INCREMENT,
  `profile_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_department` int(11) NULL DEFAULT NULL,
  `id_qc_name` int(11) NULL DEFAULT NULL,
  `id_qc_level` int(11) NULL DEFAULT NULL,
  `lot_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_user_create` int(11) NULL DEFAULT NULL,
  `date_create` datetime(0) NULL DEFAULT NULL,
  `id_user_modify` int(11) NULL DEFAULT NULL,
  `date_modify` datetime(0) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_profile_qc`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 79 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of profile_qc_master
-- ----------------------------
INSERT INTO `profile_qc_master` VALUES (1, 'profile1', 1, 1, 1, '123', 1, '2018-09-17 10:08:18', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (2, 'profile2', 2, 3, 1, '123', 1, '1970-01-01 07:00:01', NULL, NULL, 1, 1);
INSERT INTO `profile_qc_master` VALUES (3, 'aaaa', 2, 3, 2, 'undefined', 1, '1970-01-01 07:00:01', NULL, NULL, 1, 1);
INSERT INTO `profile_qc_master` VALUES (69, 'jjjjj', 1, 1, 1, 'jjjjj', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (70, 'okm', 1, 1, 1, 'okm', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (71, 'hnm', 1, 1, 1, 'hnm', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (72, 'gggg', 1, 1, 1, 'gggg', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (73, 'Profile22', 1, 1, 1, '456', 1, '1970-01-01 07:00:01', 1, '2018-09-21 13:46:34', 0, 1);
INSERT INTO `profile_qc_master` VALUES (74, 'profile23', 2, 3, 2, '123', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (75, 'profile24', 1, 1, 1, '123', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (76, 'test', 1, 1, 2, 'lot0002', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (77, 'profile99', 1, 1, 1, '999', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
INSERT INTO `profile_qc_master` VALUES (78, 'text1', 1, 3, 2, '2220', 1, '1970-01-01 07:00:01', NULL, NULL, 0, 1);
...
-- ----------------------------
-- Table structure for qc_level_master
-- ----------------------------
DROP TABLE IF EXISTS `qc_level_master`;
CREATE TABLE `qc_level_master`  (
  `id_qc_level` int(11) NOT NULL AUTO_INCREMENT,
  `qc_level` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_qc_level`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of qc_level_master
-- ----------------------------
INSERT INTO `qc_level_master` VALUES (1, 'lavel1', 0, 1);
INSERT INTO `qc_level_master` VALUES (2, 'level2', 0, 1);

-- ----------------------------
-- Table structure for qc_name_master
-- ----------------------------
DROP TABLE IF EXISTS `qc_name_master`;
CREATE TABLE `qc_name_master`  (
  `id_qc_name` int(11) NOT NULL AUTO_INCREMENT,
  `qc_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_qc_name`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of qc_name_master
-- ----------------------------
INSERT INTO `qc_name_master` VALUES (1, 'name1', 0, 1);
INSERT INTO `qc_name_master` VALUES (2, 'name1', 1, 1);
INSERT INTO `qc_name_master` VALUES (3, 'name2', 0, 1);

-- ----------------------------
-- Table structure for qc_order_detail
-- ----------------------------
DROP TABLE IF EXISTS `qc_order_detail`;
CREATE TABLE `qc_order_detail`  (
  `id_qc_profile_order_detail` int(11) NOT NULL AUTO_INCREMENT,
  `id_qc_profile_order` int(11) NULL DEFAULT NULL,
  `id_item_qc` int(11) NULL DEFAULT NULL,
  `result` double NULL DEFAULT NULL,
  `comment` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_username` int(11) NULL DEFAULT NULL,
  `analyzer` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_qc_profile_order_detail`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of qc_order_detail
-- ----------------------------
INSERT INTO `qc_order_detail` VALUES (1, 4, 18, 1, 'aaaaaaaaaa', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (2, 4, 19, 2, 'bbbbbbbbbbb', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (3, 4, 20, 3, 'ccccccccccc', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (4, 4, 21, 4, 'cddddddddd', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (5, 4, 22, 5, 'eeeeeeeeee', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (6, 4, 23, 0, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (7, 4, 24, 0, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (8, 3, 18, 11, 'rrrrrrrrr', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (9, 3, 19, 12, 'rrrrrrrrrrrrrrrrrrrr', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (10, 3, 20, 13, 'rrrrrrrrrrrrrrrrrr', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (11, 3, 21, 14, 'rrrrrrrrrrrrrrrrrrrrrr', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (12, 3, 22, 0, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (13, 3, 23, 0, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (14, 3, 24, 0, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (15, 2, 18, 55, 'w', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (16, 2, 19, 66, 'q', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (17, 2, 20, 77, 'e', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (18, 2, 21, 88, 'r', NULL, 0);
INSERT INTO `qc_order_detail` VALUES (19, 2, 22, 0, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (20, 2, 23, 0, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (21, 2, 24, 0, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (22, 7, 18, 130, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (23, 7, 19, 110, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (24, 7, 20, 135, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (25, 7, 21, 95, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (26, 7, 22, 91, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (27, 7, 23, 81, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (28, 7, 24, 110, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (29, 8, 18, 54, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (30, 8, 19, 55, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (31, 8, 20, 100, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (32, 8, 21, 105, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (33, 8, 22, 111, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (34, 8, 23, 111, NULL, NULL, 0);
INSERT INTO `qc_order_detail` VALUES (35, 8, 24, 120, NULL, NULL, 0);

-- ----------------------------
-- Table structure for qc_order_main
-- ----------------------------
DROP TABLE IF EXISTS `qc_order_main`;
CREATE TABLE `qc_order_main`  (
  `id_qc_profile_order` int(11) NOT NULL AUTO_INCREMENT,
  `id_qc_profile_main` int(11) NULL DEFAULT NULL,
  `qc_test_date` date NULL DEFAULT NULL,
  `qc_test_time` time(0) NULL DEFAULT NULL,
  `id_user_qc` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_username` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_qc_profile_order`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of qc_order_main
-- ----------------------------
INSERT INTO `qc_order_main` VALUES (1, 76, '2018-09-25', '01:17:41', 1, 0, NULL);
INSERT INTO `qc_order_main` VALUES (2, 76, '2018-09-25', '01:18:22', 1, 0, NULL);
INSERT INTO `qc_order_main` VALUES (3, 76, '2018-09-25', '01:59:42', 1, 0, NULL);
INSERT INTO `qc_order_main` VALUES (4, 76, '2018-09-25', '02:02:48', 1, 0, NULL);
INSERT INTO `qc_order_main` VALUES (6, 75, '2018-09-25', '09:23:57', 1, 0, NULL);
INSERT INTO `qc_order_main` VALUES (7, 76, '2018-09-26', '09:38:56', 1, 0, NULL);
INSERT INTO `qc_order_main` VALUES (8, 76, '2018-09-27', '14:53:59', 1, 0, NULL);
INSERT INTO `qc_order_main` VALUES (9, 69, '2018-10-18', '14:22:03', 1, 0, NULL);

-- ----------------------------
-- Table structure for religion_master
-- ----------------------------
DROP TABLE IF EXISTS `religion_master`;
CREATE TABLE `religion_master`  (
  `id_religion` int(11) NOT NULL AUTO_INCREMENT,
  `religion_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
...
-- ----------------------------
-- Records of religion_master
-- ----------------------------
INSERT INTO `religion_master` VALUES (1, 'พุทธ', 0);
INSERT INTO `religion_master` VALUES (2, 'อิสลาม', 0);
INSERT INTO `religion_master` VALUES (3, 'คริสต์', 0);
INSERT INTO `religion_master` VALUES (4, 'ฮินดู', 0);
INSERT INTO `religion_master` VALUES (5, 'เชน', 0);
INSERT INTO `religion_master` VALUES (6, 'ซิกข์', 0);
INSERT INTO `religion_master` VALUES (7, 'เต๋า', 0);
INSERT INTO `religion_master` VALUES (8, 'ขงจื๊อ', 0);
INSERT INTO `religion_master` VALUES (9, 'บัวขาว', 0);
INSERT INTO `religion_master` VALUES (10, 'เซียนเทียนเต้า', 0);
INSERT INTO `religion_master` VALUES (11, 'อนุตตรธรรม', 0);
INSERT INTO `religion_master` VALUES (12, 'ชินโต', 0);
INSERT INTO `religion_master` VALUES (13, 'ชอนโดเกียว', 0);
INSERT INTO `religion_master` VALUES (14, 'เทนริเกียว', 0);
INSERT INTO `religion_master` VALUES (15, 'อียิปต์โบราณ', 0);
INSERT INTO `religion_master` VALUES (16, 'มาณีกี', 0);
INSERT INTO `religion_master` VALUES (17, 'ยูดาห์', 0);
INSERT INTO `religion_master` VALUES (18, 'โซโรอัสเตอร์', 0);
INSERT INTO `religion_master` VALUES (19, 'บาบี', 0);
INSERT INTO `religion_master` VALUES (20, 'บาไฮ', 0);
INSERT INTO `religion_master` VALUES (21, 'พื้นบ้านจีน', 0);

-- ----------------------------
-- Table structure for service_plan_master
-- ----------------------------
DROP TABLE IF EXISTS `service_plan_master`;
CREATE TABLE `service_plan_master`  (
  `id_service_plan` int(11) NOT NULL AUTO_INCREMENT,
  `service_plan_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `service_plan_note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_service_plan`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of service_plan_master
-- ----------------------------
INSERT INTO `service_plan_master` VALUES (1, 'บัตรทอง', '', 0, 1);
INSERT INTO `service_plan_master` VALUES (2, 'บัตรเขียว', NULL, 0, 1);
INSERT INTO `service_plan_master` VALUES (3, 'บัตรเหลือง', NULL, 0, 1);
INSERT INTO `service_plan_master` VALUES (4, 'บัตรผ่าน', NULL, 0, 1);

-- ----------------------------
-- Table structure for specialty_master
-- ----------------------------
DROP TABLE IF EXISTS `specialty_master`;
CREATE TABLE `specialty_master`  (
  `id_specialty` int(11) NOT NULL AUTO_INCREMENT,
  `specialty_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of specialty_master
-- ----------------------------
INSERT INTO `specialty_master` VALUES (1, 'แพทย์ผู้ชำนาญการ', 0, 1);
INSERT INTO `specialty_master` VALUES (2, 'วิสัญญีแพทย์', 0, 1);
INSERT INTO `specialty_master` VALUES (3, 'นักรังสีการแพทย์', 0, 1);
INSERT INTO `specialty_master` VALUES (4, 'ทดสอบ', 0, 1);
INSERT INTO `specialty_master` VALUES (5, 'ทดสอบ', 0, 1);
INSERT INTO `specialty_master` VALUES (6, 'ทดสอบ', 0, 1);
INSERT INTO `specialty_master` VALUES (7, 'ทดสอบ', 0, 1);
INSERT INTO `specialty_master` VALUES (8, 'ดกเดกเกดเ', 0, 1);
INSERT INTO `specialty_master` VALUES (9, 'นัท', 0, 1);
INSERT INTO `specialty_master` VALUES (10, 'นัท', 0, 1);
INSERT INTO `specialty_master` VALUES (11, 'เเเเเ', 0, 1);
INSERT INTO `specialty_master` VALUES (12, 'เเเเเ', 0, 1);
INSERT INTO `specialty_master` VALUES (13, 'ดดดด', 0, 1);
INSERT INTO `specialty_master` VALUES (14, 'ดดดด', 0, 1);
INSERT INTO `specialty_master` VALUES (15, 'เเเเ', 0, 1);

-- ----------------------------
-- Table structure for specimen_item_reject_note_master
-- ----------------------------
DROP TABLE IF EXISTS `specimen_item_reject_note_master`;
CREATE TABLE `specimen_item_reject_note_master`  (
  `id_specimen_item_reject_note` int(11) NOT NULL AUTO_INCREMENT,
  `specimen_item_reject_note` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_specimen_item_reject_note`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of specimen_item_reject_note_master
-- ----------------------------
INSERT INTO `specimen_item_reject_note_master` VALUES (1, 'น้อยเกินไป', 0);
INSERT INTO `specimen_item_reject_note_master` VALUES (2, 'มีสีดำ', 0);
INSERT INTO `specimen_item_reject_note_master` VALUES (3, 'ปริมาณไม่พอ', 0);
INSERT INTO `specimen_item_reject_note_master` VALUES (4, 'มีสิ่งเจือปน', 0);

-- ----------------------------
-- Table structure for specimen_item_reject_order
-- ----------------------------
DROP TABLE IF EXISTS `specimen_item_reject_order`;
CREATE TABLE `specimen_item_reject_order`  (
  `id_specimen_item_reject` int(11) NOT NULL AUTO_INCREMENT,
  `id_specimen_item_reject_note` int(11) NULL DEFAULT NULL,
  `id_specimen_item` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `specimen_item_reject_date` datetime(0) NULL DEFAULT NULL,
  `id_username` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id_specimen_item_reject`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of specimen_item_reject_order
-- ----------------------------
INSERT INTO `specimen_item_reject_order` VALUES (1, 1, 25, 0, NULL, NULL);
INSERT INTO `specimen_item_reject_order` VALUES (2, 2, 25, 0, NULL, NULL);
INSERT INTO `specimen_item_reject_order` VALUES (5, 1, 24, 0, NULL, NULL);
INSERT INTO `specimen_item_reject_order` VALUES (6, 1, 23, 0, NULL, NULL);
INSERT INTO `specimen_item_reject_order` VALUES (7, 1, 25, 0, NULL, NULL);
INSERT INTO `specimen_item_reject_order` VALUES (8, 2, 25, 0, NULL, NULL);
INSERT INTO `specimen_item_reject_order` VALUES (9, 3, 25, 0, NULL, NULL);
INSERT INTO `specimen_item_reject_order` VALUES (10, 2, 25, 0, '2018-09-27 08:38:49', NULL);
INSERT INTO `specimen_item_reject_order` VALUES (11, 3, 25, 0, '2018-09-27 08:38:49', NULL);
INSERT INTO `specimen_item_reject_order` VALUES (12, 4, 25, 0, '2018-09-27 08:38:49', NULL);
INSERT INTO `specimen_item_reject_order` VALUES (13, 1, 25, 0, '2018-09-27 09:02:10', 1);
INSERT INTO `specimen_item_reject_order` VALUES (14, 1, 25, 0, '2018-09-27 09:19:56', 1);
INSERT INTO `specimen_item_reject_order` VALUES (15, 2, 25, 0, '2018-09-27 09:19:56', 1);

-- ----------------------------
-- Table structure for table_system_description
-- ----------------------------
DROP TABLE IF EXISTS `table_system_description`;
CREATE TABLE `table_system_description`  (
  `id_table_field_name` int(11) NOT NULL AUTO_INCREMENT,
  `table_field_name_use` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `table_field_name_show` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_table` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `visible` int(11) NULL DEFAULT 0,
  `priority` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`id_table_field_name`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 67 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of table_system_description
-- ----------------------------
INSERT INTO `table_system_description` VALUES (5, 'position_name', 'ชื่อตำแหน่งงาน', 4, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (11, 'specialty_name', 'ชื่อความชำนาญการ', 2, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (12, 'id_specialty', 'เลขที่อ้างอิง', 2, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (8, 'id_position', 'เลขที่อ้างอิง', 4, 0, 1, 1);
INSERT INTO `table_system_description` VALUES (9, 'ethnicity_name', 'ชื่อเชื้อชาติ', 6, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (10, 'id_ethnicity', 'เลขที่อ้างอิง', 6, 0, 1, 1);
INSERT INTO `table_system_description` VALUES (13, 'id_lab_specimen_item', 'เลขที่อ้างอิง', 7, 0, 1, 1);
INSERT INTO `table_system_description` VALUES (14, 'lab_specimen_item_name', 'ชื่อสิ่งส่งตรวจ', 7, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (15, 'lab_specimen_item_code', 'รหัสสิ่งส่งตรวจ', 7, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (16, 'lab_specimen_item_note', 'หมายเหตุ', 7, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (17, 'id_nationality', 'เลขที่อ้างอิง', 8, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (18, 'nationality_name', 'ชื่อสัญชาติ', 8, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (19, 'id_religion', 'เลขที่อ้างอิง', 9, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (20, 'religion_name', 'ชื่อศาสนา', 9, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (21, 'id_hospital', 'เลขที่อ้างอิง', 10, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (22, 'hn_hospital', 'HN โรงพยาบาล', 10, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (23, 'hospital_name', 'ชื่อโรงพยาบาล', 10, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (24, 'hospital_address', 'ที่อยู่โรงพยาบาล', 10, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (25, 'hospital_tel', 'เบอร์โทรศัพท์', 10, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (26, 'id_department', 'เลขที่อ้างอิง', 11, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (27, 'department_name', 'ชื่อแผนก', 11, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (28, 'department_note', 'หมายเหตุ', 11, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (29, 'id_patient_type', 'เลขที่อ้างอิง', 12, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (30, 'patient_type_name', 'ชื่อประเภทผู้ป่วย', 12, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (31, 'patient_type_note', 'หมายเหตุ', 12, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (32, 'id_qc_name', 'เลขที่อ้างอิง', 18, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (33, 'qc_name', 'ชื่อ QC', 18, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (34, 'id_qc_level', 'เลขที่อ้างอิง', 19, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (35, 'qc_level', 'Level QC', 19, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (36, 'id_lab_sub_group_item', 'เลขที่อ้างอิง', 20, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (37, 'lab_sub_group_name', 'ชื่อกลุ่มตรวจ', 20, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (38, 'lab_sub_group_code', 'รหัสกลุ่มตรวจ', 20, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (39, 'note', 'หมายเหตุ', 20, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (40, 'id_lab_item', 'เลขที่อ้างอิง', 21, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (41, 'lab_item_name', 'ชื่อรายการตรวจ', 21, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (42, 'lab_item_code', 'รหัสการตรวจ', 21, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (43, 'lab_item_unit', 'หน่วยรายการ', 21, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (44, 'lab_default_value', 'ค่าผลแลปอัตโนมัติ', 21, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (45, 'tat_default', 'ค่า TAT', 21, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (46, 'note', 'หมายเหตุ', 21, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (47, 'id_form', 'เลขที่อ้างอิง', 22, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (48, 'form_name', 'ชื่อฟอร์ม', 22, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (49, 'form_code', 'เลขรหัสฟอร์ม', 22, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (50, 'note', 'หมายเหตุ', 22, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (51, 'id_ward', 'เลขที่อ้างอิง', 13, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (52, 'ward_name', 'ชื่อ ward', 13, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (53, 'ward_code', 'รหัส ward', 13, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (54, 'id_Item_type', 'เลขที่อ้างอิง', 23, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (55, 'item_type_name', 'ชื่อประเภท', 23, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (56, 'id_group_barcode', 'เลขที่อ้างอิง', 24, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (57, 'group_barcode_name', 'Group Barcode', 24, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (58, 'id_group_result', 'เลขที่อ้างอิง', 25, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (59, 'group_result_name', 'Group Result', 25, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (60, 'id_lab_barcode', 'เลขที่อ้างอิง', 26, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (61, 'lab_barcode_name', 'Lab Barcode', 26, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (62, 'id_group_user', 'เลขที่อ้างอิง', 28, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (63, 'group_user_name', 'ชื่อกลุ่มผู้ใช้', 28, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (64, 'id_clinic', 'เลขที่อ้างอิง', 29, 0, 0, 1);
INSERT INTO `table_system_description` VALUES (65, 'clinic_code', 'รหัสคลินิค', 29, 0, 0, 0);
INSERT INTO `table_system_description` VALUES (66, 'clinic_name', 'ชื่อคลินิค', 29, 0, 0, 0);

-- ----------------------------
-- Table structure for table_system_master
-- ----------------------------
DROP TABLE IF EXISTS `table_system_master`;
CREATE TABLE `table_system_master`  (
  `id_table` int(11) NOT NULL AUTO_INCREMENT,
  `table_name_show` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `table_name_use` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
...
-- ----------------------------
-- Records of table_system_master
-- ----------------------------
INSERT INTO `table_system_master` VALUES (1, 'ข้อมูลแพทย์', 'doctor_master', 1);
INSERT INTO `table_system_master` VALUES (2, 'ข้อมูลความชำนาญการ', 'specialty_master', 0);
INSERT INTO `table_system_master` VALUES (3, 'ข้อมูลผู้ป่วย', 'patient_master', 1);
INSERT INTO `table_system_master` VALUES (4, 'ข้อมูลตำแหน่งงาน', 'position_master', 0);
INSERT INTO `table_system_master` VALUES (7, 'ข้อมูลสิ่งส่งตรวจ', 'lab_specimen_item_master', 0);
INSERT INTO `table_system_master` VALUES (6, 'ข้อมูลเชื้อชาตื', 'ethnicity_master', 1);
INSERT INTO `table_system_master` VALUES (8, 'ข้อมูลสัญชาติ', 'nationality_master', 1);
INSERT INTO `table_system_master` VALUES (9, 'ข้อมูลศาสนา', 'religion_master', 1);
INSERT INTO `table_system_master` VALUES (10, 'ข้อมูลโรงพยาบาล', 'hospital_master', 0);
INSERT INTO `table_system_master` VALUES (11, 'ข้อมูลแผนก', 'department_master', 0);
INSERT INTO `table_system_master` VALUES (12, 'ข้อมูลประเภทผู้ป่วย', 'patient_type', 0);
INSERT INTO `table_system_master` VALUES (18, 'ข้อมูลชื่อ QC', 'qc_name_master', 0);
INSERT INTO `table_system_master` VALUES (19, 'ข้อมูล level QC', 'qc_level_master', 0);
INSERT INTO `table_system_master` VALUES (20, 'ข้อมูลกลุ่มตรวจ', 'lab_sub_group_item_master', 0);
INSERT INTO `table_system_master` VALUES (21, 'ข้อมูลรายการตรวจ', 'lab_item_master', 0);
INSERT INTO `table_system_master` VALUES (22, 'ข้อมูลแบบฟอร์มการตรวจ', 'form_lab_master', 1);
INSERT INTO `table_system_master` VALUES (13, 'ข้อมูล ward', 'ward', 0);
INSERT INTO `table_system_master` VALUES (23, 'ข้อมูลประเภท Item Type', 'lab_item_type_master', 0);
INSERT INTO `table_system_master` VALUES (24, 'ข้อมูล Group Barcode', 'group_barcode_master', 0);
INSERT INTO `table_system_master` VALUES (25, 'ข้อมูล Group Result', 'group_result_master', 0);
INSERT INTO `table_system_master` VALUES (26, 'ข้อมูล Lab Barcode', 'lab_barcode_master', 0);
INSERT INTO `table_system_master` VALUES (28, 'ข้อมูลกลุ่มผู้ใช้', 'group_user_master', 0);
INSERT INTO `table_system_master` VALUES (29, 'ข้อมูล Clinic', 'clinic_master', 0);
...
CREATE TABLE `user_master`  (
  ...
  `regis_date` datetime(0) NULL DEFAULT NULL,
  `user_pic_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_group_user` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
  `id_hospital` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `user_master` VALUES (1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 'Admin', 'Root', 1, 1, '2018-09-11 12:58:11', NULL, 1, 0, 1);
INSERT INTO `user_master` VALUES (2, 'usertest', '21232f297a57a5a743894a0e4a801fc3', 1, 'test', 'test', 1, 1, '2018-09-11 14:14:18', NULL, 2, 0, 1);
INSERT INTO `user_master` VALUES (126, 'testgroup', '9628ffaecf05013841852cb572d50d45', 4, 'testgroup', 'testgroup', 4, 1, NULL, '/storage/Public/img/UserPic/3/126.jpg', 2, 0, 3);
INSERT INTO `user_master` VALUES (127, 'testuser', '81dc9bdb52d04dc20036dbd8313ed055', 5, 'ffff', 'ddddd', 2, 2, NULL, NULL, 2, 0, 4);
INSERT INTO `user_master` VALUES (128, 'lab101', 'e10adc3949ba59abbe56e057f20f883e', 1, 'ทดสอบชื่อ', 'ทดสอบนามสกุล', 1, 1, NULL, NULL, 1, 0, 3);
...
CREATE TABLE `users`  (
  ...
  `prefix_name` int(11) NULL DEFAULT NULL,
  `fname` varchar(191) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lastname` varchar(191) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `position` int(11) NULL DEFAULT NULL,
  `user_department` int(11) NULL DEFAULT NULL,
  `regis_date` datetime(0) NULL DEFAULT NULL,
  `user_pic_url` varchar(191) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_group_user` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT NULL,
  `id_hospital` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (3, 'admin', 'admin@gmail.com', '$2y$10$soK89SdWb7gTe0G8sDQzguPtCwrhFvreQbP78s6K1hEyx618cO4xm', NULL, '2018-09-11 05:35:15', '2018-09-11 05:35:15', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `ward`  (
  ...
  `ward_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ward_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `id_hospital` int(11) NULL DEFAULT NULL,
  `stdel` int(11) NULL DEFAULT 0,
...
-- Records of ward
-- ----------------------------
INSERT INTO `ward` VALUES (1, 'ศรีพัตน์', '0001', 1, 0);
INSERT INTO `ward` VALUES (2, 'ศรีแดง', '0002', 1, 0);
INSERT INTO `ward` VALUES (3, 'ศรีนัท', '0003', 2, 0);
